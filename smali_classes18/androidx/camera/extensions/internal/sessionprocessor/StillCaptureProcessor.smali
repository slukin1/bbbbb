...
# instance fields
.field mCaptureOutputSurface:Lo/close;

.field final mCaptureProcessorImpl:Landroidx/camera/extensions/impl/CaptureProcessorImpl;

.field final mCaptureResultImageMatcher:Lo/getActionItems;
...
.method constructor <init>(Landroidx/camera/extensions/impl/CaptureProcessorImpl;Landroid/view/Surface;Landroid/util/Size;Landroidx/camera/core/impl/OutputSurface;Z)V
    ...
    iput-object v0, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureResultImageMatcher:Lo/getActionItems;
    ...
    invoke-direct {v1, p2, p3, p5}, Lo/close;-><init>(Landroid/view/Surface;Landroid/util/Size;Z)V

    iput-object v1, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureOutputSurface:Lo/close;

    .line 1128
    iget-object p2, v1, Lo/close;->i:Landroid/view/Surface;
    ...
    .line 99
    :cond_0
    iput-boolean v0, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mIsPostviewConfigured:Z
...
.method clearCaptureResults()V
    ...
    check-cast v2, Lo/flagActionItems;

    invoke-interface {v2}, Lo/flagActionItems;->e()Z
...
.method close()V
    ...
    .line 292
    iget-object v2, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureResultImageMatcher:Lo/getActionItems;

    .line 3080
    iget-object v3, v2, Lo/getActionItems;->c:Ljava/lang/Object;
    ...
    .line 3081
    :try_start_1
    iput-object v4, v2, Lo/getActionItems;->d:Lo/getActionItems$DropdropElements2;
    :try_end_1
    ...
    invoke-virtual {v2}, Lo/getActionItems;->e()V

    .line 294
    iget-object v2, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureOutputSurface:Lo/close;

    .line 4135
    iget-object v3, v2, Lo/close;->d:Ljava/lang/Object;
    ...
    .line 4136
    :try_start_3
    iput-boolean v1, v2, Lo/close;->c:Z
    ...
    iget-boolean v1, v2, Lo/close;->b:Z

    if-eqz v1, :cond_0

    .line 4138
    iget-object v1, v2, Lo/close;->a:Landroidx/camera/core/impl/ImageReaderProxy;
    ...
    .line 4140
    iget-object v1, v2, Lo/close;->e:Landroid/media/ImageWriter;

    invoke-static {v1}, Lo/close$DemoFundsParentComponent;->gc_(Landroid/media/ImageWriter;)V
    :try_end_3
...
.method synthetic lambda$process$1$androidx-camera-extensions-internal-sessionprocessor-StillCaptureProcessor(ZLjava/util/HashMap;Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor$OnCaptureResultCallback;)V
    ...
    .line 192
    sget-object v2, Lo/addInternal;->d:Lo/addInternal;

    invoke-static {v2}, Lo/setShortcutsVisibleInner;->b(Lo/addInternal;)Z
    ...
    .line 193
    invoke-static {v2}, Lo/add;->d(Lo/addInternal;)Z
    ...
    .line 216
    :cond_2
    sget-object p1, Lo/addInternal;->b:Lo/addInternal;

    invoke-static {p1}, Lo/setShortcutsVisibleInner;->b(Lo/addInternal;)Z
    ...
    .line 218
    invoke-static {p1}, Lo/add;->d(Lo/addInternal;)Z
...
.method synthetic lambda$startCapture$0$androidx-camera-extensions-internal-sessionprocessor-StillCaptureProcessor(Ljava/util/List;Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor$OnCaptureResultCallback;ZLo/flagActionItems;Landroid/hardware/camera2/TotalCaptureResult;I)V
    .locals 3
    ...
    .line 150
    invoke-interface {p4}, Lo/flagActionItems;->e()Z
    ...
    const-string v2, "onImageReferenceIncoming  captureStageId="
    ...
    invoke-virtual {v1, p4, v2}, Ljava/util/AbstractMap;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 160
    const-string p5, "StillCaptureProcessor"

    invoke-static {p5, p4}, Landroidx/camera/core/Logger;->d(Ljava/lang/String;Ljava/lang/String;)V
...
.method notifyCaptureResult(Landroid/hardware/camera2/TotalCaptureResult;I)V
    ...
    .line 261
    iget-object v0, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureResultImageMatcher:Lo/getActionItems;

    invoke-virtual {v0, p1, p2}, Lo/getActionItems;->d(Landroid/hardware/camera2/TotalCaptureResult;I)V
    ...
    .line 268
    iget-object p2, p0, Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor;->mCaptureOutputSurface:Lo/close;

    .line 5117
    iget-boolean v2, p2, Lo/close;->f:Z

    if-eqz v2, :cond_0

    .line 5118
    iput-wide v0, p2, Lo/close;->g:J
...
.method process(Ljava/util/Map;Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor$OnCaptureResultCallback;Z)V
    ...
    check-cast v6, Lo/flagActionItems;

    .line 179
    invoke-interface {v6}, Lo/flagActionItems;->b()Landroid/media/Image;
...
.method startCapture(ZLjava/util/List;Landroidx/camera/extensions/internal/sessionprocessor/StillCaptureProcessor$OnCaptureResultCallback;)V
    ...
    const-string v1, "Start the capture: enablePostview="
    ...
    invoke-virtual {v0}, Lo/getActionItems;->e()V
