...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;->EndTag:Lio/noties/markwon/html/jsoup/parser/Token$TokenType;
    ...
    invoke-direct {v5, v7, v8}, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;->Comment:Lio/noties/markwon/html/jsoup/parser/Token$TokenType;

    .line 395
    new-instance v7, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;

    const-string v9, "Character"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;->Character:Lio/noties/markwon/html/jsoup/parser/Token$TokenType;

    .line 396
    new-instance v9, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;

    const-string v11, "EOF"

    const/4 v12, 0x5

    invoke-direct {v9, v11, v12}, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;-><init>(Ljava/lang/String;I)V

    sput-object v9, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;->EOF:Lio/noties/markwon/html/jsoup/parser/Token$TokenType;

    const/4 v11, 0x6

    .line 390
    new-array v11, v11, [Lio/noties/markwon/html/jsoup/parser/Token$TokenType;
    ...
    sput-object v11, Lio/noties/markwon/html/jsoup/parser/Token$TokenType;->$VALUES:[Lio/noties/markwon/html/jsoup/parser/Token$TokenType;
