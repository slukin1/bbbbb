...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker$DemoFundsParentComponent;
    }
.end annotation
...
.field private e:Lio/reactivex/internal/queue/MpscLinkedQueue;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;Z)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->b:Lio/reactivex/disposables/DemoFundsParentComponent;
...
.method public final c(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/DropdropElements1;
    ...
    .line 187
    invoke-virtual {p0, p1}, Lo/setIconUrls$DropdropElements3;->d(Ljava/lang/Runnable;)Lio/reactivex/disposables/DropdropElements1;
    ...
    invoke-direct {v1, v0}, Lio/reactivex/internal/disposables/SequentialDisposable;-><init>(Lio/reactivex/disposables/DropdropElements1;)V
    ...
    new-instance v3, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker$DemoFundsParentComponent;

    invoke-direct {v3, p0, v1, p1}, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker$DemoFundsParentComponent;-><init>(Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;Lio/reactivex/internal/disposables/SequentialDisposable;Ljava/lang/Runnable;)V

    iget-object p1, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->b:Lio/reactivex/disposables/DemoFundsParentComponent;

    invoke-direct {v2, v3, p1}, Lio/reactivex/internal/schedulers/ScheduledRunnable;-><init>(Ljava/lang/Runnable;Lio/reactivex/internal/disposables/DropdropElements4;)V

    .line 200
    iget-object p1, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->b:Lio/reactivex/disposables/DemoFundsParentComponent;

    invoke-virtual {p1, v2}, Lio/reactivex/disposables/DemoFundsParentComponent;->e(Lio/reactivex/disposables/DropdropElements1;)Z
    ...
    invoke-virtual {p1, v2, p2, p3, p4}, Lo/setIconUrls;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/DropdropElements1;

    move-result-object p1

    .line 213
    new-instance p2, Lio/reactivex/internal/schedulers/DropdropElements1;

    invoke-direct {p2, p1}, Lio/reactivex/internal/schedulers/DropdropElements1;-><init>(Lio/reactivex/disposables/DropdropElements1;)V

    invoke-virtual {v2, p2}, Lio/reactivex/internal/schedulers/ScheduledRunnable;->setFuture(Ljava/util/concurrent/Future;)V

    .line 3067
    :goto_0
    invoke-static {v0, v2}, Lio/reactivex/internal/disposables/DisposableHelper;->b(Ljava/util/concurrent/atomic/AtomicReference;Lio/reactivex/disposables/DropdropElements1;)Z
...
.method public final d(Ljava/lang/Runnable;)Lio/reactivex/disposables/DropdropElements1;
    ...
    iget-object v1, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->b:Lio/reactivex/disposables/DemoFundsParentComponent;
    ...
    invoke-virtual {p1, v0}, Lio/reactivex/internal/queue/MpscLinkedQueue;->b(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v0}, Lio/reactivex/internal/queue/MpscLinkedQueue;->b()V
...
.method public final dispose()V
    ...
    .line 225
    iget-object v0, p0, Lio/reactivex/internal/schedulers/ExecutorScheduler$ExecutorWorker;->b:Lio/reactivex/disposables/DemoFundsParentComponent;
...
.method public final run()V
    ...
    .line 249
    :cond_1
    invoke-virtual {v0}, Lio/reactivex/internal/queue/MpscLinkedQueue;->d()Ljava/lang/Object;
