...
.field final onOverflow:Lio/reactivex/functions/DropdropElements1;

.field outputFused:Z

.field final queue:Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# direct methods
.method constructor <init>(Lorg/reactivestreams/Subscriber;IZZLio/reactivex/functions/DropdropElements1;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 72
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->onOverflow:Lio/reactivex/functions/DropdropElements1;
    ...
    .line 83
    :goto_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;
...
.method private e()V
    ...
    .line 162
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;
    ...
    invoke-interface {v0}, Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;->c()Z

    move-result v5

    invoke-direct {p0, v4, v5, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->e(ZZLorg/reactivestreams/Subscriber;)Z
    ...
    .line 179
    :goto_1
    invoke-direct {p0, v11, v13, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->e(ZZLorg/reactivestreams/Subscriber;)Z
    ...
    .line 196
    invoke-direct {p0, v10, v11, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->e(ZZLorg/reactivestreams/Subscriber;)Z
...
.method private e(ZZLorg/reactivestreams/Subscriber;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 217
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;

    invoke-interface {p1}, Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;->b()V
    ...
    .line 234
    iget-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;

    invoke-interface {p2}, Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;->b()V
...
.method public final b()V
    ...
    invoke-interface {v0}, Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;->b()V
...
.method public final onComplete()V
    ...
    .line 133
    :cond_0
    invoke-direct {p0}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->e()V
...
.method public final onNext(Ljava/lang/Object;)V
    ...
    invoke-interface {v0, p1}, Lio/reactivex/internal/fuseable/IsolatedAddMarginComposeKtgetRiskRiskColor111;->b(Ljava/lang/Object;)Z
    ...
    .line 101
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->onOverflow:Lio/reactivex/functions/DropdropElements1;
