...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroid/support/v4/media/RatingCompat$DropdropElements2;
    }
.end annotation
...
.method public static fromRating(Ljava/lang/Object;)Landroid/support/v4/media/RatingCompat;
    ...
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->d(Landroid/media/Rating;)I

    move-result v2

    .line 336
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->c(Landroid/media/Rating;)Z
    ...
    .line 352
    :pswitch_0
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->b(Landroid/media/Rating;)F
    ...
    .line 348
    :pswitch_1
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->e(Landroid/media/Rating;)F
    ...
    .line 342
    :pswitch_2
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->h(Landroid/media/Rating;)Z
    ...
    .line 339
    :pswitch_3
    invoke-static {v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->a(Landroid/media/Rating;)Z
...
.method public final getRating()Ljava/lang/Object;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->d(F)Landroid/media/Rating;
    ...
    .line 388
    invoke-static {v0, v1}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->c(IF)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->d(Z)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->c(Z)Landroid/media/Rating;
    ...
    invoke-static {v0}, Landroid/support/v4/media/RatingCompat$DropdropElements2;->a(I)Landroid/media/Rating;
