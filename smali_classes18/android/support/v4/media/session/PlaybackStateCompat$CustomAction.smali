...
.method public static fromCustomAction(Ljava/lang/Object;)Landroid/support/v4/media/session/PlaybackStateCompat$CustomAction;
    ...
    .line 942
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->e(Landroid/media/session/PlaybackState$CustomAction;)Landroid/os/Bundle;
    ...
    .line 946
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->b(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/String;

    move-result-object v1

    .line 947
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->c(Landroid/media/session/PlaybackState$CustomAction;)Ljava/lang/CharSequence;
    ...
    invoke-static {p0}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->d(Landroid/media/session/PlaybackState$CustomAction;)I
...
.method public final getCustomAction()Ljava/lang/Object;
    ...
    .line 970
    invoke-static {v0, v1, v2}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->c(Ljava/lang/String;Ljava/lang/CharSequence;I)Landroid/media/session/PlaybackState$CustomAction$Builder;
    ...
    invoke-static {v0, v1}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->c(Landroid/media/session/PlaybackState$CustomAction$Builder;Landroid/os/Bundle;)V

    .line 972
    invoke-static {v0}, Landroid/support/v4/media/session/PlaybackStateCompat$DropdropElements1;->b(Landroid/media/session/PlaybackState$CustomAction$Builder;)Landroid/media/session/PlaybackState$CustomAction;
