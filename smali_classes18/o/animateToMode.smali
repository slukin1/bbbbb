.class Lo/animateToMode;
.super Lo/completeDeferredDestroyActionMode;
.source "SourceFile"
...
.method constructor <init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
    ...
    .line 40
    invoke-direct {p0, p1, p2}, Lo/completeDeferredDestroyActionMode;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V

    return-void
.end method

.method static c(Landroid/hardware/camera2/CameraDevice;Landroid/os/Handler;)Lo/animateToMode;
    .locals 2

    .line 45
    new-instance v0, Lo/animateToMode;
    ...
    invoke-direct {v0, p0, v1}, Lo/animateToMode;-><init>(Landroid/hardware/camera2/CameraDevice;Ljava/lang/Object;)V
...
.method public a(Lo/jumpToCurrentState;)V
    ...
    invoke-static {v0, p1}, Lo/animateToMode;->d(Landroid/hardware/camera2/CameraDevice;Lo/jumpToCurrentState;)V
    ...
    invoke-static {v1}, Lo/animateToMode;->c(Ljava/util/List;)Ljava/util/List;
    ...
    invoke-virtual {p0, p1, v1, v0, v2}, Lo/animateToMode;->a(Landroid/hardware/camera2/CameraDevice;Ljava/util/List;Landroid/hardware/camera2/CameraCaptureSession$StateCallback;Landroid/os/Handler;)V
    :try_end_0
