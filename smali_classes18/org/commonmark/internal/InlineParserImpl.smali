...
.method private static addDelimiterProcessorForChar(CLorg/commonmark/parser/delimiter/DelimiterProcessor;Ljava/util/Map;)V
    ...
    const-string p2, "Delimiter processor conflict with delimiter char \'"
...
.method private parseAutolink()Lorg/commonmark/node/Node;
    ...
    invoke-direct {v3, v2, v1}, Lorg/commonmark/node/Link;-><init>(Ljava/lang/String;Ljava/lang/String;)V
...
.method private processDelimiters(Lorg/commonmark/internal/Delimiter;)V
    ...
    .line 781
    iget v7, v5, Lorg/commonmark/internal/Delimiter;->length:I

    sub-int/2addr v7, v8

    iput v7, v5, Lorg/commonmark/internal/Delimiter;->length:I

    .line 782
    iget v7, v1, Lorg/commonmark/internal/Delimiter;->length:I

    sub-int/2addr v7, v8

    iput v7, v1, Lorg/commonmark/internal/Delimiter;->length:I
    ...
    .line 783
    invoke-virtual {v2, v7}, Lorg/commonmark/node/Text;->setLiteral(Ljava/lang/String;)V
    ...
    .line 794
    invoke-interface {v3, v2, v4, v8}, Lorg/commonmark/parser/delimiter/DelimiterProcessor;->process(Lorg/commonmark/node/Text;Lorg/commonmark/node/Text;I)V
