.class public Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;
...
# direct methods
.method public constructor <init>(Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;Lde/authada/org/bouncycastle/tls/crypto/TlsKemConfig;)V
    .locals 0

    .line 65354
    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->crypto:Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/tls/crypto/TlsKemConfig;->getNamedGroup()I

    move-result p1

    invoke-static {p1}, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->getKyberParameters(I)Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberParameters;

    move-result-object p1

    iput-object p1, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->kyberParameters:Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberParameters;

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/tls/crypto/TlsKemConfig;->isServer()Z

    move-result p1

    iput-boolean p1, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->isServer:Z
...
# virtual methods
.method public adoptLocalSecret([B)Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsSecret;
    .locals 1

    .line 65352
    iget-object v0, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->crypto:Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;
...
.method public createKem()Lde/authada/org/bouncycastle/tls/crypto/TlsAgreement;
    ...
    .line 65351
    new-instance v0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKem;

    invoke-direct {v0, p0}, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKem;-><init>(Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;)V

    return-object v0
.end method

.method public decapsulate(Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberPrivateKeyParameters;[B)Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsSecret;
    .locals 1
    ...
    invoke-virtual {p0, p1}, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->adoptLocalSecret([B)Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsSecret;
...
.method public decodePublicKey([B)Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberPublicKeyParameters;
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->kyberParameters:Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberParameters;
...
.method public encapsulate(Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberPublicKeyParameters;)Lde/authada/org/bouncycastle/crypto/SecretWithEncapsulation;
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->crypto:Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;->getSecureRandom()Ljava/security/SecureRandom;
...
.method public generateKeyPair()Lde/authada/org/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->crypto:Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsCrypto;
    ...
    iget-object v3, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->kyberParameters:Lde/authada/org/bouncycastle/pqc/crypto/crystals/kyber/KyberParameters;
...
.method public isServer()Z
    ...
    .line 65345
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/tls/crypto/impl/bc/BcTlsMLKemDomain;->isServer:Z
