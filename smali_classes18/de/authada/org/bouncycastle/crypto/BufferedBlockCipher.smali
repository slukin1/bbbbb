.class public Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;
...
.field protected cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;
...
.method public constructor <init>(Lde/authada/org/bouncycastle/crypto/BlockCipher;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->mbCipher:Lde/authada/org/bouncycastle/crypto/MultiBlockCipher;
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B
    ...
    iput v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I
    ...
    :goto_1
    iput-boolean v4, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->pgpCFB:Z
    ...
    :cond_2
    iput-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->partialBlockOkay:Z

    return-void

    :cond_3
    iput-boolean v3, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->partialBlockOkay:Z
...
.method public doFinal([BI)I
    ...
    .line 65352
    :try_start_0
    iget v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I
    ...
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->partialBlockOkay:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;

    iget-object v2, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B

    invoke-interface {v0, v2, v1, v2, v1}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    iget v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    iput v1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I
...
.method public getOutputSize(I)I
    ...
    .line 65350
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->pgpCFB:Z

    if-eqz v0, :cond_0

    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->forEncryption:Z
...
.method public getUpdateOutputSize(I)I
    ...
    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B

    array-length v0, v0

    rem-int v0, p1, v0

    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;
...
.method public init(ZLde/authada/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 65347
    iput-boolean p1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->forEncryption:Z
...
.method public processByte(B[BI)I
    ...
    iget v1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I
    ...
    iget-object p1, p0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;
...
.method public processBytes([BII[BI)I
    ...
    :cond_1
    :goto_0
    iget-object v4, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B

    array-length v5, v4

    iget v6, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I
    ...
    iget-object v4, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;

    iget-object v6, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B

    invoke-interface {v4, v6, v10, v8, v9}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I

    move-result v11

    iput v10, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    sub-int v12, v2, v5

    add-int v13, v1, v5

    iget-object v1, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->mbCipher:Lde/authada/org/bouncycastle/crypto/MultiBlockCipher;
    ...
    :cond_2
    :goto_1
    iget-object v1, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B

    array-length v1, v1

    if-le v12, v1, :cond_4

    iget-object v1, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;
    ...
    iget v2, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    invoke-static {v7, v13, v1, v2, v12}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget v1, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    add-int/2addr v1, v12

    iput v1, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->bufOff:I

    iget-object v2, v0, Lde/authada/org/bouncycastle/crypto/BufferedBlockCipher;->buf:[B
