.class public Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;
...
# instance fields
.field private final algId:Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;

.field private final digest:Lde/authada/org/bouncycastle/crypto/Digest;

.field private forSigning:Z

.field private final rsaEngine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->oidMap:Ljava/util/Hashtable;
    ...
    sget-object v2, Lde/authada/org/bouncycastle/asn1/x509/X509ObjectIdentifiers;->id_SHA1:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
...
.method public constructor <init>(Lde/authada/org/bouncycastle/crypto/Digest;)V
    ...
    .line 65353
    sget-object v0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->oidMap:Ljava/util/Hashtable;
    ...
    invoke-direct {p0, p1, v0}, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;-><init>(Lde/authada/org/bouncycastle/crypto/Digest;Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)V

    return-void
.end method

.method public constructor <init>(Lde/authada/org/bouncycastle/crypto/Digest;Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)V
    .locals 2
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->rsaEngine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;

    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
    ...
    :goto_0
    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->algId:Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
...
.method private derEncode([B)[B
    ...
    .line 65351
    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->algId:Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;

    if-nez v0, :cond_0

    :try_start_0
    invoke-static {p1}, Lde/authada/org/bouncycastle/asn1/x509/DigestInfo;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/asn1/x509/DigestInfo;
    :try_end_0
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->algId:Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
...
.method public generateSignature()[B
    ...
    .line 65350
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->forSigning:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
    ...
    :try_start_0
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->derEncode([B)[B

    move-result-object v0

    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->rsaEngine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;
    ...
    new-instance v2, Lde/authada/org/bouncycastle/crypto/CryptoException;

    invoke-virtual {v1}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v2, v1, v0}, Lde/authada/org/bouncycastle/crypto/CryptoException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public init(ZLde/authada/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 65348
    iput-boolean p1, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->forSigning:Z
    ...
    :cond_4
    :goto_2
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->reset()V

    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->rsaEngine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;
...
.method public verifySignature([B)Z
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
    ...
    :try_start_0
    iget-object v2, p0, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->rsaEngine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;

    array-length v4, p1

    invoke-interface {v2, p1, v3, v4}, Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;->processBlock([BII)[B

    move-result-object p1

    invoke-direct {p0, v1}, Lde/authada/org/bouncycastle/crypto/signers/RSADigestSigner;->derEncode([B)[B
    ...
    invoke-static {p1, v1}, Lde/authada/org/bouncycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
    ...
    :cond_4
    invoke-static {v1, v1}, Lde/authada/org/bouncycastle/util/Arrays;->constantTimeAreEqual([B[B)Z
