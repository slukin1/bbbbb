.class public Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;
...
.method public constructor <init>(Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;Lde/authada/org/bouncycastle/crypto/Digest;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->engine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;

    iput-object p2, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
...
.method public generateSignature()[B
    ...
    .line 65353
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->forSigning:Z

    if-eqz v0, :cond_0

    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->digest:Lde/authada/org/bouncycastle/crypto/Digest;

    const/4 v3, 0x0

    invoke-interface {v2, v1, v3}, Lde/authada/org/bouncycastle/crypto/Digest;->doFinal([BI)I

    iget-object v2, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->engine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;

    invoke-interface {v2, v1, v3, v0}, Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;->processBlock([BII)[B
...
.method public init(ZLde/authada/org/bouncycastle/crypto/CipherParameters;)V
    ...
    .line 65352
    iput-boolean p1, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->forSigning:Z
    ...
    :cond_4
    :goto_2
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->reset()V

    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/signers/GenericSigner;->engine:Lde/authada/org/bouncycastle/crypto/AsymmetricBlockCipher;
