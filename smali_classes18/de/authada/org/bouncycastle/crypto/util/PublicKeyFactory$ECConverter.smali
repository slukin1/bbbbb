.class Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$ECConverter;
...
.method synthetic constructor <init>(Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 65353
    invoke-direct {p0}, Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$ECConverter;-><init>()V
...
.method getPublicKeyParameters(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/crypto/ec/CustomNamedCurves;->getByOID(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;

    move-result-object v0

    if-nez v0, :cond_0

    invoke-static {p2}, Lde/authada/org/bouncycastle/asn1/x9/ECNamedCurveTable;->getByOID(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;
    ...
    invoke-direct {v1, p2, v0}, Lde/authada/org/bouncycastle/crypto/params/ECNamedDomainParameters;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;)V
    ...
    check-cast v1, Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;

    move-result-object p2

    invoke-direct {v1, p2}, Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;-><init>(Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;)V
    ...
    invoke-virtual {v0, v3}, Lde/authada/org/bouncycastle/asn1/x9/X9IntegerConverter;->getByteLength(Lde/authada/org/bouncycastle/math/ec/ECCurve;)I
    ...
    check-cast p2, Lde/authada/org/bouncycastle/asn1/ASN1OctetString;
    :try_end_0
    ...
    invoke-direct {v0, v2, p2}, Lde/authada/org/bouncycastle/asn1/x9/X9ECPoint;-><init>(Lde/authada/org/bouncycastle/math/ec/ECCurve;Lde/authada/org/bouncycastle/asn1/ASN1OctetString;)V
