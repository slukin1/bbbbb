.class Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$DSTUConverter;
...
.method synthetic constructor <init>(Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 65353
    invoke-direct {p0}, Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$DSTUConverter;-><init>()V
...
.method getPublicKeyParameters(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145Params;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/asn1/ua/DSTU4145Params;
    ...
    invoke-direct {p0, p1}, Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$DSTUConverter;->reverseBytes([B)V

    :cond_0
    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145Params;->isNamedCurve()Z

    move-result v1

    if-eqz v1, :cond_1

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145Params;->getNamedCurve()Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object p2

    invoke-static {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145NamedCurves;->getByOID(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;
    ...
    :cond_1
    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145Params;->getECBinary()Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;

    move-result-object p2

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;->getB()[B

    move-result-object v1

    sget-object v2, Lde/authada/org/bouncycastle/asn1/ua/UAObjectIdentifiers;->dstu4145le:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-direct {p0, v1}, Lde/authada/org/bouncycastle/crypto/util/PublicKeyFactory$DSTUConverter;->reverseBytes([B)V
    ...
    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;->getField()Lde/authada/org/bouncycastle/asn1/ua/DSTU4145BinaryField;

    move-result-object v1

    new-instance v2, Lde/authada/org/bouncycastle/math/ec/ECCurve$F2m;

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145BinaryField;->getM()I

    move-result v4

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145BinaryField;->getK1()I

    move-result v5

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145BinaryField;->getK2()I

    move-result v6

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145BinaryField;->getK3()I

    move-result v7

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;->getA()Ljava/math/BigInteger;
    ...
    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;->getG()[B
    ...
    invoke-virtual {v0, v3}, Lde/authada/org/bouncycastle/asn1/ASN1Primitive;->equals(Lde/authada/org/bouncycastle/asn1/ASN1Primitive;)Z
    ...
    invoke-static {v2, v1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145PointEncoder;->decodePoint(Lde/authada/org/bouncycastle/math/ec/ECCurve;[B)Lde/authada/org/bouncycastle/math/ec/ECPoint;

    move-result-object v1

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145ECBinary;->getN()Ljava/math/BigInteger;

    move-result-object p2

    invoke-direct {v0, v2, v1, p2}, Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;-><init>(Lde/authada/org/bouncycastle/math/ec/ECCurve;Lde/authada/org/bouncycastle/math/ec/ECPoint;Ljava/math/BigInteger;)V
    ...
    invoke-static {v1, p1}, Lde/authada/org/bouncycastle/asn1/ua/DSTU4145PointEncoder;->decodePoint(Lde/authada/org/bouncycastle/math/ec/ECCurve;[B)Lde/authada/org/bouncycastle/math/ec/ECPoint;
