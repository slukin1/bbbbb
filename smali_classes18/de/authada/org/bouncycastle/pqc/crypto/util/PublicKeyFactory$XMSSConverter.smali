.class Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$XMSSConverter;
...
.method synthetic constructor <init>(Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 65353
    invoke-direct {p0}, Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$XMSSConverter;-><init>()V
...
.method getPublicKeyParameters(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/pqc/asn1/XMSSKeyParams;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/pqc/asn1/XMSSKeyParams;

    move-result-object p2

    if-eqz p2, :cond_0

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/pqc/asn1/XMSSKeyParams;->getTreeDigest()Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-virtual {p2}, Lde/authada/org/bouncycastle/pqc/asn1/XMSSKeyParams;->getHeight()I
    ...
    invoke-direct {v2, p2, v0}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSParameters;-><init>(ILde/authada/org/bouncycastle/crypto/Digest;)V
    ...
    invoke-virtual {v1, p2}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;->withPublicSeed([B)Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;
    ...
    invoke-virtual {p2, p1}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;->withRoot([B)Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;
    ...
    new-instance p2, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;
    ...
    invoke-static {v0}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSParameters;->lookupByOID(I)Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSParameters;

    move-result-object v0

    invoke-direct {p2, v0}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;-><init>(Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSParameters;)V

    invoke-virtual {p2, p1}, Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;->withPublicKey([B)Lde/authada/org/bouncycastle/pqc/crypto/xmss/XMSSPublicKeyParameters$Builder;
