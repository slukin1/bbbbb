.class Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$CMCEConverter;
...
.method synthetic constructor <init>(Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$1;)V
    ...
    .line 65353
    invoke-direct {p0}, Lde/authada/org/bouncycastle/pqc/crypto/util/PublicKeyFactory$CMCEConverter;-><init>()V
...
.method getPublicKeyParameters(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;Ljava/lang/Object;)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/pqc/asn1/CMCEPublicKey;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/pqc/asn1/CMCEPublicKey;

    move-result-object p2

    invoke-virtual {p2}, Lde/authada/org/bouncycastle/pqc/asn1/CMCEPublicKey;->getT()[B

    move-result-object p2

    new-instance v0, Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEPublicKeyParameters;
    ...
    invoke-direct {v0, v1, p2}, Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEPublicKeyParameters;-><init>(Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEParameters;[B)V
    :try_end_0
    ...
    invoke-static {p1}, Lde/authada/org/bouncycastle/pqc/crypto/util/Utils;->mcElieceParamsLookup(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEParameters;

    move-result-object p1

    invoke-direct {v0, p1, p2}, Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEPublicKeyParameters;-><init>(Lde/authada/org/bouncycastle/pqc/crypto/cmce/CMCEParameters;[B)V
