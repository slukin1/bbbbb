...
.method static fromBitmapConfig(Landroid/graphics/Bitmap$Config;)Lorg/tensorflow/lite/support/image/ColorSpaceType;
    ...
    const-string v1, "Bitmap configuration: "
...
.method convertTensorBufferToBitmap(Lorg/tensorflow/lite/support/tensorbuffer/TensorBuffer;)Landroid/graphics/Bitmap;
    ...
    const-string v0, "convertTensorBufferToBitmap() is unsupported for the color space type "
...
.method getChannelValue()I
    ...
    const-string v1, "getChannelValue() is unsupported for the color space type "
...
.method getNormalizedShape([I)[I
    ...
    const-string v0, "getNormalizedShape() is unsupported for the color space type "
...
.method getShapeInfoMessage()Ljava/lang/String;
    ...
    const-string v1, "getShapeInfoMessage() is unsupported for the color space type "
...
.method toBitmapConfig()Landroid/graphics/Bitmap$Config;
    ...
    const-string v1, "toBitmapConfig() is unsupported for the color space type "
