...
.method private readDO87(Ljava/io/DataInputStream;Z)[B
    ...
    const-string p2, "DO\'87 expected 0x01 marker, found "
...
.method private wrapCommandAPDU(Lnet/sf/scuba/smartcards/CommandAPDU;)Lnet/sf/scuba/smartcards/CommandAPDU;
    ...
    .line 326
    :goto_2
    invoke-virtual {v12, v10}, Ljava/io/OutputStream;->write(I)V
    ...
    .line 329
    invoke-virtual {v12, v9}, Ljava/io/OutputStream;->write(I)V

    .line 331
    :cond_3
    array-length v4, v5

    invoke-virtual {v12, v5, v8, v4}, Ljava/io/OutputStream;->write([BII)V
    ...
    .line 353
    invoke-virtual {v12, v0, v8, v4}, Ljava/io/OutputStream;->write([BII)V
...
.method public hashCode()I
    ...
    .line 569
    iget-boolean v3, p0, Lorg/jmrtd/protocol/SecureMessagingWrapper;->shouldCheckMAC:Z
    ...
    .line 570
    :goto_1
    iget-wide v4, p0, Lorg/jmrtd/protocol/SecureMessagingWrapper;->ssc:J
