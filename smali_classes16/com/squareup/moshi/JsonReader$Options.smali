...
# instance fields
.field final doubleQuoteSuffix:Lo/setSession;
...
.method private constructor <init>([Ljava/lang/String;Lo/setSession;)V
    ...
    .line 623
    iput-object p2, p0, Lcom/squareup/moshi/JsonReader$Options;->doubleQuoteSuffix:Lo/setSession;
...
.method public static varargs of([Ljava/lang/String;)Lcom/squareup/moshi/JsonReader$Options;
    ...
    invoke-static {v1, v3}, Lcom/squareup/moshi/JsonUtf8Writer;->string(Lo/setPureUrl;Ljava/lang/String;)V
    ...
    invoke-direct {v1, p0, v0}, Lcom/squareup/moshi/JsonReader$Options;-><init>([Ljava/lang/String;Lo/setSession;)V
    :try_end_0
