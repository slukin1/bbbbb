...
.method public static of(Lo/setPureUrl;)Lcom/squareup/moshi/JsonWriter;
    .locals 1

    .line 180
    new-instance v0, Lcom/squareup/moshi/JsonUtf8Writer;

    invoke-direct {v0, p0}, Lcom/squareup/moshi/JsonUtf8Writer;-><init>(Lo/setPureUrl;)V
...
.method final checkStack()Z
    ...
    iget-object v3, v0, Lcom/squareup/moshi/JsonValueWriter;->stack:[Ljava/lang/Object;
...
.method public final value(Lo/getPureUrl;)Lcom/squareup/moshi/JsonWriter;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    .line 385
    invoke-virtual {p0}, Lcom/squareup/moshi/JsonWriter;->valueSink()Lo/setPureUrl;

    move-result-object v0

    .line 386
    :try_start_0
    invoke-interface {p1, v0}, Lo/getPureUrl;->e(Lo/setSte;)J
    :try_end_0
...
.method public abstract valueSink()Lo/setPureUrl;
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
        }
