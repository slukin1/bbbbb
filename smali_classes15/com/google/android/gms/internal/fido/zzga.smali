...
.method public constructor <init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    .line 1
    invoke-direct {p0}, Lo/setFuturesSymbol;-><init>()V

    const-string p1, "SHA-256"

    invoke-static {p1}, Lcom/google/android/gms/internal/fido/zzga;->d(Ljava/lang/String;)Ljava/security/MessageDigest;
    ...
    .line 3
    invoke-static {p1}, Lcom/google/android/gms/internal/fido/zzga;->b(Ljava/security/MessageDigest;)Z
...
# virtual methods
.method public final c()Lo/setSpotSide;
    .locals 4
    ...
    :try_start_0
    new-instance v0, Lo/CmGridDetailPOCreator;
    ...
    invoke-direct {v0, v2, v3, v1}, Lo/CmGridDetailPOCreator;-><init>(Ljava/security/MessageDigest;ILo/getStrategyAmount;)V
    :try_end_0
    .catch Ljava/lang/CloneNotSupportedException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    .line 2
    new-instance v2, Lo/CmGridDetailPOCreator;

    invoke-virtual {v0}, Ljava/security/MessageDigest;->getAlgorithm()Ljava/lang/String;

    move-result-object v0

    invoke-static {v0}, Lcom/google/android/gms/internal/fido/zzga;->d(Ljava/lang/String;)Ljava/security/MessageDigest;

    move-result-object v0

    iget v3, p0, Lcom/google/android/gms/internal/fido/zzga;->zzb:I

    invoke-direct {v2, v0, v3, v1}, Lo/CmGridDetailPOCreator;-><init>(Ljava/security/MessageDigest;ILo/getStrategyAmount;)V
