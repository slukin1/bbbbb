.class public final Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;
...
.field static timeSourceRef:Ljava/util/concurrent/atomic/AtomicReference;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;",
            ">;"
        }
    .end annotation
.end field
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->timeSourceRef:Ljava/util/concurrent/atomic/AtomicReference;
...
.method static getAbbrMonthDayFormat(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    invoke-static {v0, p0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getAndroidFormat(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
...
.method private static getAndroidFormat(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    .line 140
    invoke-static {p0, p1}, Lo/TextLinkScopeLinksComposables131;->qe_(Ljava/lang/String;Ljava/util/Locale;)Landroid/icu/text/DateFormat;

    move-result-object p0

    .line 141
    invoke-static {}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getUtcAndroidTimeZone()Landroid/icu/util/TimeZone;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/geetest/sdk/utils/q$$ExternalSyntheticApiModelOutline0;->m(Landroid/icu/text/DateFormat;Landroid/icu/util/TimeZone;)V

    .line 142
    invoke-static {}, Lcom/geetest/sdk/utils/q$$ExternalSyntheticApiModelOutline0;->m()Landroid/icu/text/DisplayContext;

    move-result-object p1

    invoke-static {p0, p1}, Lcom/geetest/sdk/utils/q$$ExternalSyntheticApiModelOutline0;->m(Landroid/icu/text/DateFormat;Landroid/icu/text/DisplayContext;)V
...
.method public static getDayCopy(Ljava/util/Calendar;)Ljava/util/Calendar;
    ...
    .line 114
    invoke-static {p0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getUtcCalendarOf(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method public static getDefaultTextInputFormat()Ljava/text/SimpleDateFormat;
    ...
    .line 162
    invoke-static {v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getDatePatternAsInputFormat(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 164
    invoke-static {}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getTimeZone()Ljava/util/TimeZone;
...
.method static getFullFormat(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 271
    invoke-static {v0, p0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getFormat(ILjava/util/Locale;)Ljava/text/DateFormat;
...
.method static getMediumNoYear(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    .line 261
    invoke-static {p0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getMediumFormat(Ljava/util/Locale;)Ljava/text/DateFormat;
    ...
    invoke-static {v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->removeYearFromDateFormatPattern(Ljava/lang/String;)Ljava/lang/String;
...
.method static getTimeSource()Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;
    .locals 1

    .line 48
    sget-object v0, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->timeSourceRef:Ljava/util/concurrent/atomic/AtomicReference;

    invoke-virtual {v0}, Ljava/util/concurrent/atomic/AtomicReference;->get()Ljava/lang/Object;

    move-result-object v0

    check-cast v0, Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;

    if-nez v0, :cond_0

    .line 49
    invoke-static {}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;->system()Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;
...
.method public static getTodayCalendar()Ljava/util/Calendar;
    ...
    .line 67
    invoke-static {}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getTimeSource()Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;

    move-result-object v0

    invoke-virtual {v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData110;->now()Ljava/util/Calendar;
...
.method private static getUtcAndroidTimeZone()Landroid/icu/util/TimeZone;
    ...
    invoke-static {v0}, Lo/TextLinkScopeLinksComposables131;->qh_(Ljava/lang/String;)Landroid/icu/util/TimeZone;
...
.method public static getUtcCalendar()Ljava/util/Calendar;
    ...
    .line 84
    invoke-static {v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->getUtcCalendarOf(Ljava/util/Calendar;)Ljava/util/Calendar;
...
.method private static removeYearFromDateFormatPattern(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, v1, v2, v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->findCharactersInDateFormatPattern(Ljava/lang/String;Ljava/lang/String;II)I
    ...
    .line 294
    invoke-static {p0, v1, v4, v0}, Lo/W3AlphaTradeParentFragmentsubscribeLiveData15;->findCharactersInDateFormatPattern(Ljava/lang/String;Ljava/lang/String;II)I
