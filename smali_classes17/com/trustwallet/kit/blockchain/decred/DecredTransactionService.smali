.class public final Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "p1",
        "<init>",
        "(Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;)V",
        ...
        "serializeToRaw",
        "(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/trustwallet/core/decred/SigningOutput;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;",
...
# instance fields
.field private final bitcoinTransactionService:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;

.field private final rpcClient:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;


# direct methods
.method public constructor <init>(Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;)V
    .locals 0
    ...
    .line 15
    iput-object p1, p0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->bitcoinTransactionService:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;

    .line 16
    iput-object p2, p0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->rpcClient:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;
...
.method public final findTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Account;Ljava/lang/String;Lo/setThumbIconSize;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    ...
    .line 37
    iget-object v0, p0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->bitcoinTransactionService:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;

    invoke-virtual {v0, p1, p2, p3, p4}, Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinTransactionService;->findTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Account;Ljava/lang/String;Lo/setThumbIconSize;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
...
.method public final sendRawTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Ljava/lang/String;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    ...
    instance-of v0, p3, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;

    if-eqz v0, :cond_0

    move-object v0, p3

    check-cast v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;

    iget v1, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->label:I
    ...
    iget p3, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->label:I

    add-int/2addr p3, v2

    iput p3, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;

    invoke-direct {v0, p0, p3}, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;-><init>(Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)V

    :goto_0
    iget-object p3, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->result:Ljava/lang/Object;

    .line 1057
    sget-object v1, Lkotlin/coroutines/intrinsics/CoroutineSingletons;->COROUTINE_SUSPENDED:Lkotlin/coroutines/intrinsics/CoroutineSingletons;

    .line 23
    iget v2, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->label:I
    ...
    .line 28
    :try_start_1
    iget-object p3, p0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->rpcClient:Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;

    invoke-interface {p1}, Lcom/trustwallet/kit/common/blockchain/entity/Chain;->getCoinType()Lcom/trustwallet/core/CoinType;

    move-result-object p1

    iput v3, v0, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService$sendRawTransaction$1;->label:I

    invoke-virtual {p3, p1, p2, v0}, Lcom/trustwallet/kit/blockchain/bitcoin/BitcoinRpcClient;->broadcastTransaction(Lcom/trustwallet/core/CoinType;Ljava/lang/String;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
...
.method public final bridge synthetic sendTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/squareup/wire/Message;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->sendTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/trustwallet/core/decred/SigningOutput;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
...
.method public final sendTransaction(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/trustwallet/core/decred/SigningOutput;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public final bridge synthetic serializeToRaw(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/squareup/wire/Message;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/trustwallet/kit/blockchain/decred/DecredTransactionService;->serializeToRaw(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/trustwallet/core/decred/SigningOutput;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
...
.method public final serializeToRaw(Lcom/trustwallet/kit/common/blockchain/entity/Chain;Lcom/trustwallet/core/decred/SigningOutput;Lo/WalletNecessaryDataHelperfetchActiveNetwork21;)Ljava/lang/Object;
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
