.class public final Lo/getClearHide;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        ...
        "",
        "e",
        "(Ljava/lang/String;Lcom/binance/data/beans/MultipleChartPairType;)Z"
    }
    k = 0x1
    mv = {
        0x2,
...
# static fields
.field public static final INSTANCE:Lo/getClearHide;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Lo/getClearHide;

    invoke-direct {v0}, Lo/getClearHide;-><init>()V

    sput-object v0, Lo/getClearHide;->INSTANCE:Lo/getClearHide;
...
.method public static c(Ljava/util/List;Ljava/util/List;)V
    ...
    .line 31
    const-string v0, "deselectedList"
    ...
    const-string v2, "biz://finance/marketDetail/v1/updateMultipleChartSymbols"
    ...
    .line 108
    :cond_1
    new-instance v0, Lo/getClearHide$DropdropElements4;

    invoke-direct {v0}, Lo/getClearHide$DropdropElements4;-><init>()V
    ...
    const-string v8, "biz://finance/marketDetail/v1/updateMultipleChartSymbols"
...
.method private static d()Ljava/util/List;
    ...
    const-string v1, "biz://finance/marketDetail/v1/getMultipleChartSymbols"

    const/4 v2, 0x0

    invoke-virtual {v0, v1, v2, v2, v2}, Lcom/finance/csframework/protocol/Request$Companion;->toRequest(Ljava/lang/String;Ljava/util/Map;Ljava/util/Map;Ljava/lang/Object;)Lcom/finance/csframework/protocol/Request;
    ...
    .line 63
    :cond_1
    new-instance v0, Lo/getClearHide$DemoFundsParentComponent;

    invoke-direct {v0}, Lo/getClearHide$DemoFundsParentComponent;-><init>()V
    ...
    const-string v4, "null cannot be cast to non-null type kotlin.collections.List<com.binance.data.beans.MultipleChartPairInfo>"
    ...
    const-string v8, "biz://finance/marketDetail/v1/getMultipleChartSymbols"
...
# virtual methods
.method public final e(Ljava/lang/String;Lcom/binance/data/beans/MultipleChartPairType;)Z
    .locals 6

    .line 36
    invoke-static {}, Lo/getClearHide;->d()Ljava/util/List;
    ...
    check-cast v4, Lcom/binance/data/beans/MultipleChartPairInfo;

    .line 38
    invoke-virtual {v4}, Lcom/binance/data/beans/MultipleChartPairInfo;->getType()Lcom/binance/data/beans/MultipleChartPairType;

    move-result-object v5

    if-ne v5, p2, :cond_0

    invoke-virtual {v4}, Lcom/binance/data/beans/MultipleChartPairInfo;->getName()Ljava/lang/String;
    ...
    .line 37
    :cond_1
    check-cast v2, Lcom/binance/data/beans/MultipleChartPairInfo;
