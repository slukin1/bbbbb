.class public final Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;
    }
.end annotation
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;",
...
# static fields
.field public static final Companion:Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;
...
.method static constructor <clinit>()V
    ...
    new-instance v0, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;

    const/4 v1, 0x0

    invoke-direct {v0, v1}, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;-><init>(Lkotlin/jvm/internal/DefaultConstructorMarker;)V

    sput-object v0, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;->Companion:Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion;

    .line 56
    new-instance v0, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion$factory$1;

    invoke-direct {v0}, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter$Companion$factory$1;-><init>()V

    check-cast v0, Lde/authada/mobile/okhttp3/internal/platform/android/DeferredSocketAdapter$Factory;

    sput-object v0, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;->factory:Lde/authada/mobile/okhttp3/internal/platform/android/DeferredSocketAdapter$Factory;
...
.method public static final synthetic access$getFactory$cp()Lde/authada/mobile/okhttp3/internal/platform/android/DeferredSocketAdapter$Factory;
    ...
    .line 28
    sget-object v0, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;->factory:Lde/authada/mobile/okhttp3/internal/platform/android/DeferredSocketAdapter$Factory;
...
.method public final configureTlsExtensions(Ljavax/net/ssl/SSLSocket;Ljava/lang/String;Ljava/util/List;)V
    ...
    .line 45
    invoke-virtual {p0, p1}, Lde/authada/mobile/okhttp3/internal/platform/android/ConscryptSocketAdapter;->matchesSocket(Ljavax/net/ssl/SSLSocket;)Z
