.class final Lde/authada/eid/card/pace/apdus/GeneralAuthenticateMapNonceFactory;
...
.method static generalAuthenticateMapNonce(Lde/authada/org/bouncycastle/crypto/params/ECPublicKeyParameters;)Lde/authada/eid/card/api/CommandAPDU;
    .locals 3
    ...
    .line 34
    invoke-static {p0}, Lde/authada/eid/card/asn1/pace/MappingData;->fromKeyParameter(Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lde/authada/eid/card/asn1/pace/MappingData;

    move-result-object v2

    invoke-virtual {v2}, Lde/authada/eid/card/asn1/pace/MappingData;->toASN1Primitive()Lde/authada/org/bouncycastle/asn1/ASN1Primitive;
    ...
    .line 38
    invoke-static {v0}, Lde/authada/eid/card/pace/apdus/GeneralAuthenticateMapNonceFactory;->configBuilder(Lde/authada/eid/card/CommandAPDUBuilder;)Lde/authada/eid/card/CommandAPDUBuilder;
    ...
    new-instance v1, Lde/authada/eid/card/pace/apdus/GeneralAuthenticateMapNonceFactory$$ExternalSyntheticLambda0;

    invoke-direct {v1, p0}, Lde/authada/eid/card/pace/apdus/GeneralAuthenticateMapNonceFactory$$ExternalSyntheticLambda0;-><init>(Lde/authada/org/bouncycastle/crypto/params/ECPublicKeyParameters;)V

    .line 40
    invoke-static {v1}, Lde/authada/eid/card/pace/apdus/GeneralAuthenticateMapNonceFactory;->baseHandler(Lde/authada/eid/card/api/ResponseAPDUHandler;)Lde/authada/eid/card/api/ResponseAPDUHandler;
...
.method static synthetic lambda$generalAuthenticateMapNonce$0(Lde/authada/org/bouncycastle/crypto/params/ECPublicKeyParameters;Lde/authada/eid/card/api/ResponseAPDU;)Lde/authada/org/bouncycastle/crypto/params/ECPublicKeyParameters;
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    invoke-static {p1}, Lde/authada/eid/card/asn1/pace/MappingData;->getInstance(Lde/authada/org/bouncycastle/asn1/ASN1Primitive;)Lde/authada/eid/card/asn1/pace/MappingData;
    ...
    invoke-virtual {p1, p0}, Lde/authada/eid/card/asn1/pace/MappingData;->getECPublicKeyParameters(Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;)Lde/authada/org/bouncycastle/crypto/params/ECPublicKeyParameters;
    ...
    const-string v0, "Failed to proceed with step Map Nonce"
