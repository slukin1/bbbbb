.class public final Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault1;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault1$DropdropElements2;
    }
.end annotation


# direct methods
.method public static final e(Lcom/finance/futures/common/feature/symbol/ui/enums/FuturesSelectSymbolTypeEnum;)Lo/LeaderBoardOptionsRankFragmentspecialinlinedviewModelsdefault8;
    .locals 14

    .line 37
    sget-object v0, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault1$DropdropElements2;->b:[I
    ...
    .line 61
    new-instance p0, Lo/LeaderBoardSearchFragmentsetUpViews111;

    invoke-direct {p0}, Lo/LeaderBoardSearchFragmentsetUpViews111;-><init>()V

    check-cast p0, Lo/LeaderBoardOptionsRankFragmentspecialinlinedviewModelsdefault8;
    ...
    const-string v0, "/v1/getDemoUmHotSearchFragmentDiffer"
    ...
    .line 85
    :cond_2
    new-instance v1, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault1$DropdropElements1;

    invoke-direct {v1}, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault1$DropdropElements1;-><init>()V
    ...
    instance-of v3, v1, Lo/LeaderBoardOptionsRankFragmentspecialinlinedviewModelsdefault8;
    ...
    :cond_3
    :try_start_1
    check-cast v1, Lo/LeaderBoardOptionsRankFragmentspecialinlinedviewModelsdefault8;
    ...
    const-string v3, "null cannot be cast to non-null type com.finance.um.feature.select.differ.hotsearch.IUmHotSearchFragmentDiffer"
    ...
    .line 51
    :cond_b
    new-instance p0, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault3;

    invoke-direct {p0}, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault3;-><init>()V
    ...
    .line 47
    :cond_c
    new-instance p0, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault4;

    invoke-direct {p0}, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault4;-><init>()V
    ...
    .line 43
    :cond_d
    new-instance p0, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault2;

    invoke-direct {p0}, Lo/LeaderBoardOptionsSearchFragmentspecialinlinedviewModelsdefault2;-><init>()V
    ...
    .line 39
    :cond_e
    new-instance p0, Lo/LeaderBoardOptionsSearchFragment;

    invoke-direct {p0}, Lo/LeaderBoardOptionsSearchFragment;-><init>()V
