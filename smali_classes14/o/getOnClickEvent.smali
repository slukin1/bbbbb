.class public final Lo/getOnClickEvent;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lo/getOnClickEvent;->b:Lo/setCurrentTradeSide;
...
.method public static synthetic b(Lo/getOnClickEvent;Lo/getCloseDrawable$DropdropElements1$DropdropElements3;Lcom/finance/commonbusiness/feature/future/data/po/FuturesMarketPairBO;)Lo/getCloseDrawable$DropdropElements1$DropdropElements3;
    .locals 2

    .line 13031
    invoke-virtual {p0}, Lo/getOnClickEvent;->e()Ljava/util/List;
...
.method public static synthetic e(Lo/getOnClickEvent;Lo/getCloseDrawable$DropdropElements1$DropdropElements3;)Lkotlin/Unit;
    .locals 0

    .line 17038
    invoke-virtual {p0}, Lo/getOnClickEvent;->a()Lo/MeasurePassDelegateremeasure12;
...
.method public static synthetic e(Lkotlin/jvm/functions/Function2;Ljava/lang/Object;Ljava/lang/Object;)Lo/getCloseDrawable$DropdropElements1$DropdropElements3;
    .locals 0
...
.method public final d()Lo/getIconUrls;
    ...
    invoke-virtual {p0}, Lo/getOnClickEvent;->c()Lcom/finance/strategy/framework/network/bean/TradingBotsReq;

    move-result-object v1

    invoke-interface {v0, v1}, Lo/FuturesEventsClosedOrderRepositorygetClosedOrderList22;->d(Lcom/finance/strategy/framework/network/bean/TradingBotsReq;)Lo/getIconUrls;

    move-result-object v0

    if-eqz v0, :cond_0

    new-instance v1, Lo/EmergencyAnnouncementStoreBean;

    invoke-direct {v1}, Lo/EmergencyAnnouncementStoreBean;-><init>()V

    .line 22
    new-instance v2, Lo/isPairMatched;

    invoke-direct {v2, v1}, Lo/isPairMatched;-><init>(Lkotlin/jvm/functions/Function1;)V
...
.method public final g()V
    ...
    .line 30
    invoke-virtual {p0}, Lo/getOnClickEvent;->b()Lio/reactivex/subjects/PublishSubject;
    ...
    .line 24000
    iget-object v1, p0, Lo/getOnClickEvent;->b:Lo/setCurrentTradeSide;
    ...
    new-instance v2, Lo/getOnLinkClickListener;

    new-instance v3, Lo/getOnClickCloseEvent;

    invoke-direct {v3, p0}, Lo/getOnClickCloseEvent;-><init>(Lo/getOnClickEvent;)V

    invoke-direct {v2, v3}, Lo/getOnLinkClickListener;-><init>(Lkotlin/jvm/functions/Function2;)V
    ...
    .line 37
    new-instance v1, Lo/getTimeInterval;

    new-instance v2, Lo/getShowClose;

    invoke-direct {v2, p0}, Lo/getShowClose;-><init>(Lo/getOnClickEvent;)V

    invoke-direct {v1, v2}, Lo/getTimeInterval;-><init>(Lkotlin/jvm/functions/Function1;)V
