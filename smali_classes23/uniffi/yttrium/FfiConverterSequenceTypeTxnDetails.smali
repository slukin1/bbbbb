.class public final Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;",
        "Luniffi/yttrium/FfiConverterRustBuffer;",
        "",
        "Luniffi/yttrium/TxnDetails;",
        "<init>",
...
# static fields
.field public static final INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;

    invoke-direct {v0}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;-><init>()V

    sput-object v0, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;
...
.method public final bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->allocationSize-I7RO_PI(Ljava/util/List;)J
...
.method public final allocationSize-I7RO_PI(Ljava/util/List;)J
    ...
    .line 5444
    check-cast v1, Luniffi/yttrium/TxnDetails;

    .line 4916
    sget-object v2, Luniffi/yttrium/FfiConverterTypeTxnDetails;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTxnDetails;

    invoke-virtual {v2, v1}, Luniffi/yttrium/FfiConverterTypeTxnDetails;->allocationSize-I7RO_PI(Luniffi/yttrium/TxnDetails;)J
...
.method public final bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->lift(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4906
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->lower(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/yttrium/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->lowerIntoRustBuffer(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 4906
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->read(Ljava/nio/ByteBuffer;)Ljava/util/List;
...
.method public final read(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 4910
    sget-object v3, Luniffi/yttrium/FfiConverterTypeTxnDetails;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTxnDetails;

    invoke-virtual {v3, p1}, Luniffi/yttrium/FfiConverterTypeTxnDetails;->read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/TxnDetails;
...
.method public final bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1, p2}, Luniffi/yttrium/FfiConverterSequenceTypeTxnDetails;->write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
...
.method public final write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
    ...
    check-cast v0, Luniffi/yttrium/TxnDetails;

    .line 4923
    sget-object v1, Luniffi/yttrium/FfiConverterTypeTxnDetails;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTxnDetails;

    invoke-virtual {v1, v0, p2}, Luniffi/yttrium/FfiConverterTypeTxnDetails;->write(Luniffi/yttrium/TxnDetails;Ljava/nio/ByteBuffer;)V
