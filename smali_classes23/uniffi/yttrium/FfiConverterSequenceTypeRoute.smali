.class public final Luniffi/yttrium/FfiConverterSequenceTypeRoute;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/yttrium/FfiConverterSequenceTypeRoute;",
        "Luniffi/yttrium/FfiConverterRustBuffer;",
        "",
        "Luniffi/yttrium/Route;",
        "<init>",
...
# static fields
.field public static final INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeRoute;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Luniffi/yttrium/FfiConverterSequenceTypeRoute;

    invoke-direct {v0}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;-><init>()V

    sput-object v0, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeRoute;
...
.method public final bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->allocationSize-I7RO_PI(Ljava/util/List;)J
...
.method public final allocationSize-I7RO_PI(Ljava/util/List;)J
    ...
    .line 5444
    check-cast v1, Luniffi/yttrium/Route;

    .line 5000
    sget-object v2, Luniffi/yttrium/FfiConverterTypeRoute;->INSTANCE:Luniffi/yttrium/FfiConverterTypeRoute;

    invoke-virtual {v2, v1}, Luniffi/yttrium/FfiConverterTypeRoute;->allocationSize-I7RO_PI(Luniffi/yttrium/Route;)J
...
.method public final bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->lift(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4990
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->lower(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/yttrium/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->lowerIntoRustBuffer(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 4990
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->read(Ljava/nio/ByteBuffer;)Ljava/util/List;
...
.method public final read(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 4994
    sget-object v3, Luniffi/yttrium/FfiConverterTypeRoute;->INSTANCE:Luniffi/yttrium/FfiConverterTypeRoute;

    invoke-virtual {v3, p1}, Luniffi/yttrium/FfiConverterTypeRoute;->read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/Route;
...
.method public final bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1, p2}, Luniffi/yttrium/FfiConverterSequenceTypeRoute;->write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
...
.method public final write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
    ...
    .line 5007
    sget-object v1, Luniffi/yttrium/FfiConverterTypeRoute;->INSTANCE:Luniffi/yttrium/FfiConverterTypeRoute;

    invoke-virtual {v1, v0, p2}, Luniffi/yttrium/FfiConverterTypeRoute;->write(Luniffi/yttrium/Route;Ljava/nio/ByteBuffer;)V
