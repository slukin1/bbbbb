.class public final Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;",
        "Luniffi/yttrium/FfiConverterRustBuffer;",
        "",
        "Luniffi/yttrium/AddressOrNative;",
        "<init>",
...
# static fields
.field public static final INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;

    invoke-direct {v0}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;-><init>()V

    sput-object v0, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;
...
.method public final bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->allocationSize-I7RO_PI(Ljava/util/List;)J
...
.method public final allocationSize-I7RO_PI(Ljava/util/List;)J
    ...
    .line 5444
    check-cast v1, Luniffi/yttrium/AddressOrNative;

    .line 4944
    sget-object v2, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->INSTANCE:Luniffi/yttrium/FfiConverterTypeAddressOrNative;

    invoke-virtual {v2, v1}, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->allocationSize-I7RO_PI(Luniffi/yttrium/AddressOrNative;)J
...
.method public final bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->lift(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4934
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->lower(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/yttrium/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->lowerIntoRustBuffer(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 4934
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->read(Ljava/nio/ByteBuffer;)Ljava/util/List;
...
.method public final read(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 4938
    sget-object v3, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->INSTANCE:Luniffi/yttrium/FfiConverterTypeAddressOrNative;

    invoke-virtual {v3, p1}, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/AddressOrNative;
...
.method public final bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1, p2}, Luniffi/yttrium/FfiConverterSequenceTypeAddressOrNative;->write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
...
.method public final write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
    ...
    .line 4951
    sget-object v1, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->INSTANCE:Luniffi/yttrium/FfiConverterTypeAddressOrNative;

    invoke-virtual {v1, v0, p2}, Luniffi/yttrium/FfiConverterTypeAddressOrNative;->write(Luniffi/yttrium/AddressOrNative;Ljava/nio/ByteBuffer;)V
