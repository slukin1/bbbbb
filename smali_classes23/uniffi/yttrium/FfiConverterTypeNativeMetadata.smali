.class public final Luniffi/yttrium/FfiConverterTypeNativeMetadata;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/yttrium/FfiConverterTypeNativeMetadata;",
        "Luniffi/yttrium/FfiConverterRustBuffer;",
        "Luniffi/yttrium/NativeMetadata;",
        "<init>",
        "()V",
        ...
        "(Luniffi/yttrium/NativeMetadata;)J",
        "allocationSize",
        "Ljava/nio/ByteBuffer;",
        "read",
        "(Ljava/nio/ByteBuffer;)Luniffi/yttrium/NativeMetadata;",
        "p1",
        "",
        "write",
        "(Luniffi/yttrium/NativeMetadata;Ljava/nio/ByteBuffer;)V"
    }
    k = 0x1
    mv = {
        0x1,
...
# static fields
.field public static final INSTANCE:Luniffi/yttrium/FfiConverterTypeNativeMetadata;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Luniffi/yttrium/FfiConverterTypeNativeMetadata;

    invoke-direct {v0}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;-><init>()V

    sput-object v0, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->INSTANCE:Luniffi/yttrium/FfiConverterTypeNativeMetadata;
...
.method public final bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    .line 2186
    check-cast p1, Luniffi/yttrium/NativeMetadata;

    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->allocationSize-I7RO_PI(Luniffi/yttrium/NativeMetadata;)J
...
.method public final allocationSize-I7RO_PI(Luniffi/yttrium/NativeMetadata;)J
    .locals 5

    .line 2199
    sget-object v0, Luniffi/yttrium/FfiConverterString;->INSTANCE:Luniffi/yttrium/FfiConverterString;

    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getName()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getSymbol()Ljava/lang/String;
    ...
    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getDecimals-w2LRezQ()B
    ...
    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getValue()Ljava/lang/Double;
    ...
    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getPrice()D
    ...
    invoke-virtual {p1}, Luniffi/yttrium/NativeMetadata;->getIconUrl()Ljava/lang/String;
...
.method public final bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->lift(Luniffi/yttrium/RustBuffer$ByValue;)Luniffi/yttrium/NativeMetadata;
...
.method public final lift(Luniffi/yttrium/RustBuffer$ByValue;)Luniffi/yttrium/NativeMetadata;
    .locals 0
...
.method public final bridge synthetic liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 2186
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Luniffi/yttrium/NativeMetadata;
...
.method public final liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Luniffi/yttrium/NativeMetadata;
    .locals 0
...
.method public final bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->lower(Luniffi/yttrium/NativeMetadata;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final lower(Luniffi/yttrium/NativeMetadata;)Luniffi/yttrium/RustBuffer$ByValue;
    .locals 0
...
.method public final bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/yttrium/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->lowerIntoRustBuffer(Luniffi/yttrium/NativeMetadata;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final lowerIntoRustBuffer(Luniffi/yttrium/NativeMetadata;)Luniffi/yttrium/RustBuffer$ByValue;
    .locals 0
...
.method public final bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 2186
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/NativeMetadata;
...
.method public final read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/NativeMetadata;
    .locals 10
    ...
    .line 2188
    new-instance p1, Luniffi/yttrium/NativeMetadata;

    const/4 v9, 0x0

    move-object v1, p1

    invoke-direct/range {v1 .. v9}, Luniffi/yttrium/NativeMetadata;-><init>(Ljava/lang/String;Ljava/lang/String;BLjava/lang/Double;DLjava/lang/String;Lkotlin/jvm/internal/DefaultConstructorMarker;)V
...
.method public final bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1, p2}, Luniffi/yttrium/FfiConverterTypeNativeMetadata;->write(Luniffi/yttrium/NativeMetadata;Ljava/nio/ByteBuffer;)V

    return-void
.end method

.method public final write(Luniffi/yttrium/NativeMetadata;Ljava/nio/ByteBuffer;)V
    .locals 3
