.class public final Luniffi/yttrium/FfiConverterSequenceTypeTransaction;
...
.annotation runtime Lkotlin/Metadata;
    ...
    d2 = {
        "Luniffi/yttrium/FfiConverterSequenceTypeTransaction;",
        "Luniffi/yttrium/FfiConverterRustBuffer;",
        "",
        "Luniffi/yttrium/Transaction;",
        "<init>",
...
# static fields
.field public static final INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeTransaction;
...
.method static constructor <clinit>()V
    ...
    .line 65354
    new-instance v0, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;

    invoke-direct {v0}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;-><init>()V

    sput-object v0, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->INSTANCE:Luniffi/yttrium/FfiConverterSequenceTypeTransaction;
...
.method public final bridge synthetic allocationSize-I7RO_PI(Ljava/lang/Object;)J
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->allocationSize-I7RO_PI(Ljava/util/List;)J
...
.method public final allocationSize-I7RO_PI(Ljava/util/List;)J
    ...
    .line 5444
    check-cast v1, Luniffi/yttrium/Transaction;

    .line 4860
    sget-object v2, Luniffi/yttrium/FfiConverterTypeTransaction;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTransaction;

    invoke-virtual {v2, v1}, Luniffi/yttrium/FfiConverterTypeTransaction;->allocationSize-I7RO_PI(Luniffi/yttrium/Transaction;)J
...
.method public final bridge synthetic lift(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->lift(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/lang/Object;
    ...
    .line 4850
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->liftFromRustBuffer(Luniffi/yttrium/RustBuffer$ByValue;)Ljava/util/List;
...
.method public final bridge synthetic lower(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->lower(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic lowerIntoRustBuffer(Ljava/lang/Object;)Luniffi/yttrium/RustBuffer$ByValue;
    ...
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->lowerIntoRustBuffer(Ljava/util/List;)Luniffi/yttrium/RustBuffer$ByValue;
...
.method public final bridge synthetic read(Ljava/nio/ByteBuffer;)Ljava/lang/Object;
    ...
    .line 4850
    invoke-virtual {p0, p1}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->read(Ljava/nio/ByteBuffer;)Ljava/util/List;
...
.method public final read(Ljava/nio/ByteBuffer;)Ljava/util/List;
    ...
    .line 4854
    sget-object v3, Luniffi/yttrium/FfiConverterTypeTransaction;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTransaction;

    invoke-virtual {v3, p1}, Luniffi/yttrium/FfiConverterTypeTransaction;->read(Ljava/nio/ByteBuffer;)Luniffi/yttrium/Transaction;
...
.method public final bridge synthetic write(Ljava/lang/Object;Ljava/nio/ByteBuffer;)V
    ...
    invoke-virtual {p0, p1, p2}, Luniffi/yttrium/FfiConverterSequenceTypeTransaction;->write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
...
.method public final write(Ljava/util/List;Ljava/nio/ByteBuffer;)V
    ...
    check-cast v0, Luniffi/yttrium/Transaction;

    .line 4867
    sget-object v1, Luniffi/yttrium/FfiConverterTypeTransaction;->INSTANCE:Luniffi/yttrium/FfiConverterTypeTransaction;

    invoke-virtual {v1, v0, p2}, Luniffi/yttrium/FfiConverterTypeTransaction;->write(Luniffi/yttrium/Transaction;Ljava/nio/ByteBuffer;)V
