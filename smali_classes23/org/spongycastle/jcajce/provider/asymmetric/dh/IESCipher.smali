...
.method public engineDoFinal([BII)[B
    ...
    .line 400
    iget-object p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->engineSpec:Lorg/spongycastle/jce/spec/IESParameterSpec;

    invoke-virtual {p2}, Lorg/spongycastle/jce/spec/IESParameterSpec;->getDerivationV()[B
    ...
    .line 401
    invoke-virtual {p3}, Lorg/spongycastle/jce/spec/IESParameterSpec;->getEncodingV()[B
    ...
    invoke-virtual {v1}, Lorg/spongycastle/jce/spec/IESParameterSpec;->getCipherKeySize()I

    move-result v1

    invoke-direct {v2, p2, p3, v0, v1}, Lorg/spongycastle/crypto/params/IESWithCipherParameters;-><init>([B[BII)V

    .line 405
    iget-object p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->engineSpec:Lorg/spongycastle/jce/spec/IESParameterSpec;

    invoke-virtual {p2}, Lorg/spongycastle/jce/spec/IESParameterSpec;->getNonce()[B
    ...
    invoke-direct {p2, v2, p3}, Lorg/spongycastle/crypto/params/ParametersWithIV;-><init>(Lorg/spongycastle/crypto/CipherParameters;[B)V

    move-object v2, p2

    .line 410
    :cond_1
    iget-object p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->key:Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;

    check-cast p2, Lorg/spongycastle/crypto/params/DHKeyParameters;

    invoke-virtual {p2}, Lorg/spongycastle/crypto/params/DHKeyParameters;->getParameters()Lorg/spongycastle/crypto/params/DHParameters;

    move-result-object p2

    .line 413
    iget-object p3, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->otherKeyParameter:Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;
    ...
    .line 417
    :try_start_0
    iget p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->state:I
    ...
    invoke-virtual {p2, v4, v0, p3, v2}, Lorg/spongycastle/crypto/engines/IESEngine;->init(ZLorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-virtual {p2, v3, p3, v0, v2}, Lorg/spongycastle/crypto/engines/IESEngine;->init(ZLorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/CipherParameters;)V
    ...
    invoke-direct {p2, v1, p1}, Lorg/spongycastle/jcajce/provider/util/BadBlockException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    new-instance v0, Lorg/spongycastle/crypto/parsers/DHIESPublicKeyParser;
    ...
    invoke-direct {v0, v3}, Lorg/spongycastle/crypto/parsers/DHIESPublicKeyParser;-><init>(Lorg/spongycastle/crypto/params/DHParameters;)V

    invoke-virtual {p2, p3, v2, v0}, Lorg/spongycastle/crypto/engines/IESEngine;->init(Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/KeyParser;)V
    ...
    .line 436
    :cond_6
    new-instance p3, Lorg/spongycastle/crypto/generators/DHKeyPairGenerator;

    invoke-direct {p3}, Lorg/spongycastle/crypto/generators/DHKeyPairGenerator;-><init>()V
    ...
    invoke-direct {v0, v3, p2}, Lorg/spongycastle/crypto/params/DHKeyGenerationParameters;-><init>(Ljava/security/SecureRandom;Lorg/spongycastle/crypto/params/DHParameters;)V

    invoke-virtual {p3, v0}, Lorg/spongycastle/crypto/generators/DHKeyPairGenerator;->init(Lorg/spongycastle/crypto/KeyGenerationParameters;)V

    .line 439
    new-instance p2, Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;
    ...
    invoke-direct {p2, p3, v0}, Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;-><init>(Lorg/spongycastle/crypto/AsymmetricCipherKeyPairGenerator;Lorg/spongycastle/crypto/KeyEncoder;)V
    ...
    invoke-virtual {p3, v0, v2, p2}, Lorg/spongycastle/crypto/engines/IESEngine;->init(Lorg/spongycastle/crypto/params/AsymmetricKeyParameter;Lorg/spongycastle/crypto/CipherParameters;Lorg/spongycastle/crypto/generators/EphemeralKeyPairGenerator;)V
...
.method public engineInit(ILjava/security/Key;Ljava/security/spec/AlgorithmParameterSpec;Ljava/security/SecureRandom;)V
    ...
    iget p2, p0, Lorg/spongycastle/jcajce/provider/asymmetric/dh/IESCipher;->ivLength:I
