...
.method public Verify([B[B)[B
    ...
    :goto_f
    add-int/lit8 v24, v14, 0x7

    move/from16 v25, v5

    ushr-int/lit8 v5, v24, 0x3
    ...
    .line 249
    invoke-static {v11, v5, v1, v15, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
    ...
    invoke-interface {v6, v1, v15, v7}, Lorg/spongycastle/crypto/Digest;->update([BII)V
    ...
    invoke-interface {v6, v1, v15}, Lorg/spongycastle/crypto/Digest;->doFinal([BI)I
    ...
    .line 259
    invoke-static {v1, v15, v12, v5, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V
