...
.method static constructor <clinit>()V
    ...
    invoke-direct {v1, v5, v3}, Lio/flutter/embedding/android/KeyboardMap$PressingGoal;-><init>(I[Lio/flutter/embedding/android/KeyboardMap$KeyPair;)V

    new-instance v3, Lio/flutter/embedding/android/KeyboardMap$KeyPair;

    const-wide/32 v5, 0x700e1

    const-wide v7, 0x200000102L

    invoke-direct {v3, v5, v6, v7, v8}, Lio/flutter/embedding/android/KeyboardMap$KeyPair;-><init>(JJ)V

    new-instance v5, Lio/flutter/embedding/android/KeyboardMap$KeyPair;

    const-wide/32 v6, 0x700e5

    const-wide v8, 0x200000103L

    invoke-direct {v5, v6, v7, v8, v9}, Lio/flutter/embedding/android/KeyboardMap$KeyPair;-><init>(JJ)V

    new-array v6, v2, [Lio/flutter/embedding/android/KeyboardMap$KeyPair;
    ...
    invoke-direct {v3, v0, v6}, Lio/flutter/embedding/android/KeyboardMap$PressingGoal;-><init>(I[Lio/flutter/embedding/android/KeyboardMap$KeyPair;)V
    ...
    new-array v7, v2, [Lio/flutter/embedding/android/KeyboardMap$KeyPair;

    aput-object v5, v7, v4

    aput-object v6, v7, v0

    new-instance v5, Lio/flutter/embedding/android/KeyboardMap$PressingGoal;

    invoke-direct {v5, v2, v7}, Lio/flutter/embedding/android/KeyboardMap$PressingGoal;-><init>(I[Lio/flutter/embedding/android/KeyboardMap$KeyPair;)V
