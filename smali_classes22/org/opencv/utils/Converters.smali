...
.method public static Mat_to_vector_DMatch(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    invoke-direct {v3, v4, v5, v6, p0}, Lorg/opencv/core/DMatch;-><init>(IIIF)V
    ...
    const-string v0, "CvType.CV_64FC4 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_KeyPoint(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    mul-int/lit8 p0, v2, 0x7

    .line 512
    new-instance v11, Lorg/opencv/core/KeyPoint;
    ...
    const-string v0, "CvType.CV_64FC(7) != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_Mat(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_32SC2 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_Point(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    invoke-direct {v2, v5, v6, v7, v8}, Lorg/opencv/core/Point;-><init>(DD)V
    ...
    const-string v0, "Input Mat should be of CV_32SC2, CV_32FC2 or CV_64FC2 type\n"
    ...
    const-string v0, "Input Mat should have one column\n"
...
.method public static Mat_to_vector_Point3(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "Input Mat should be of CV_32SC3, CV_32FC3 or CV_64FC3 type\n"
...
.method public static Mat_to_vector_Rect(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    invoke-direct {v3, v4, v5, v6, p0}, Lorg/opencv/core/Rect;-><init>(IIII)V
    ...
    const-string v0, "CvType.CV_32SC4 != m.type() ||  m.rows()!=1\n"
...
.method public static Mat_to_vector_Rect2d(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    .line 473
    new-instance v12, Lorg/opencv/core/Rect2d;
    ...
    const-string v0, "CvType.CV_64FC4 != m.type() ||  m.rows()!=1\n"
...
.method public static Mat_to_vector_RotatedRect(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    mul-int/lit8 p0, v2, 0x5

    .line 803
    new-instance v3, Lorg/opencv/core/RotatedRect;
    ...
    invoke-direct {v3, v4, v5, v6, v7}, Lorg/opencv/core/RotatedRect;-><init>(Lorg/opencv/core/Point;Lorg/opencv/core/Size;D)V
    ...
    const-string v0, "CvType.CV_32FC5 != m.type() ||  m.rows()!=1\n"
...
.method public static Mat_to_vector_char(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_8SC1 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_double(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_64FC1 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_float(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_32FC1 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_int(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_32SC1 != m.type() ||  m.cols()!=1\n"
...
.method public static Mat_to_vector_uchar(Lorg/opencv/core/Mat;Ljava/util/List;)V
    ...
    const-string v0, "CvType.CV_8UC1 != m.type() ||  m.cols()!=1\n"
