...
.method public engineLoad(Ljava/io/InputStream;[C)V
    ...
    invoke-direct {p1, v0, p2}, Lorg/bouncycastle/jcajce/io/CipherInputStream;-><init>(Ljava/io/InputStream;Ljavax/crypto/Cipher;)V
    ...
    invoke-direct {v0, p1, p2}, Lorg/bouncycastle/crypto/io/DigestInputStream;-><init>(Ljava/io/InputStream;Lorg/bouncycastle/crypto/Digest;)V
    ...
    invoke-static {p1, p2}, Lorg/bouncycastle/util/io/Streams;->readFully(Ljava/io/InputStream;[B)I
...
.method public engineStore(Ljava/io/OutputStream;[C)V
    ...
    invoke-direct {p1, v0, p2}, Lorg/bouncycastle/jcajce/io/CipherOutputStream;-><init>(Ljava/io/OutputStream;Ljavax/crypto/Cipher;)V

    new-instance p2, Lorg/bouncycastle/crypto/io/DigestOutputStream;

    new-instance v0, Lorg/bouncycastle/crypto/digests/SHA1Digest;

    invoke-direct {v0}, Lorg/bouncycastle/crypto/digests/SHA1Digest;-><init>()V

    invoke-direct {p2, v0}, Lorg/bouncycastle/crypto/io/DigestOutputStream;-><init>(Lorg/bouncycastle/crypto/Digest;)V

    new-instance v0, Lorg/bouncycastle/util/io/TeeOutputStream;

    invoke-direct {v0, p1, p2}, Lorg/bouncycastle/util/io/TeeOutputStream;-><init>(Ljava/io/OutputStream;Ljava/io/OutputStream;)V
    ...
    invoke-virtual {p2}, Lorg/bouncycastle/crypto/io/DigestOutputStream;->getDigest()[B
