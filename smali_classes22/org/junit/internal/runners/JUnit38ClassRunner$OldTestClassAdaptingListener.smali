...
# interfaces
.implements Lo/getSeedPhraseVersion;
...
.method private asDescription(Lo/getNativeTokenAddress;)Lorg/junit/runner/Description;
    .locals 1
    ...
    .line 55
    :cond_0
    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->getEffectiveClass(Lo/getNativeTokenAddress;)Ljava/lang/Class;

    move-result-object v0

    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->getName(Lo/getNativeTokenAddress;)Ljava/lang/String;
...
.method private getEffectiveClass(Lo/getNativeTokenAddress;)Ljava/lang/Class;
    .locals 0
...
.method private getName(Lo/getNativeTokenAddress;)Ljava/lang/String;
    .locals 1

    .line 63
    instance-of v0, p1, Lo/getNativeTokenId;

    if-eqz v0, :cond_0

    .line 64
    check-cast p1, Lo/getNativeTokenId;

    .line 1498
    iget-object p1, p1, Lo/getNativeTokenId;->d:Ljava/lang/String;
...
# virtual methods
.method public final addError(Lo/getNativeTokenAddress;Ljava/lang/Throwable;)V
    .locals 1

    .line 46
    new-instance v0, Lorg/junit/runner/notification/Failure;

    invoke-direct {p0, p1}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->asDescription(Lo/getNativeTokenAddress;)Lorg/junit/runner/Description;
...
.method public final addFailure(Lo/getNativeTokenAddress;Ljunit/framework/AssertionFailedError;)V
    .locals 0

    .line 71
    invoke-virtual {p0, p1, p2}, Lorg/junit/internal/runners/JUnit38ClassRunner$OldTestClassAdaptingListener;->addError(Lo/getNativeTokenAddress;Ljava/lang/Throwable;)V

    return-void
.end method

.method public final endTest(Lo/getNativeTokenAddress;)V
    .locals 1
...
.method public final startTest(Lo/getNativeTokenAddress;)V
    .locals 1
