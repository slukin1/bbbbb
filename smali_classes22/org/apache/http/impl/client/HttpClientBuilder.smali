...
.method public build()Lorg/apache/http/impl/client/CloseableHttpClient;
    ...
    invoke-virtual {v4, v5, v0}, Lorg/apache/http/config/RegistryBuilder;->register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;
    ...
    iget-wide v4, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->connTimeToLive:J

    iget-object v6, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->connTimeToLiveTimeUnit:Ljava/util/concurrent/TimeUnit;
    ...
    new-instance v6, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;
    ...
    .line 999
    invoke-virtual {v6, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultSocketConfig(Lorg/apache/http/config/SocketConfig;)V
    ...
    .line 1002
    invoke-virtual {v6, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultConnectionConfig(Lorg/apache/http/config/ConnectionConfig;)V
    ...
    .line 1009
    invoke-virtual {v6, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setDefaultMaxPerRoute(I)V

    shl-int/2addr v0, v12

    .line 1010
    invoke-virtual {v6, v0}, Lorg/apache/http/impl/conn/PoolingHttpClientConnectionManager;->setMaxTotal(I)V
    ...
    .line 1066
    new-array v0, v14, [Lorg/apache/http/HttpRequestInterceptor;
    ...
    invoke-direct {v3, v1, v2}, Lorg/apache/http/impl/conn/SystemDefaultRoutePlanner;-><init>(Lorg/apache/http/conn/SchemePortResolver;Ljava/net/ProxySelector;)V
    ...
    .line 1170
    :cond_2a
    iget-object v2, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->serviceUnavailStrategy:Lorg/apache/http/client/ServiceUnavailableRetryStrategy;
    ...
    invoke-direct {v3, v0, v2}, Lorg/apache/http/impl/execchain/ServiceUnavailableRetryExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/client/ServiceUnavailableRetryStrategy;)V

    move-object v0, v3

    .line 1176
    :cond_2b
    iget-boolean v2, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->redirectHandlingDisabled:Z

    if-nez v2, :cond_2d

    .line 1177
    iget-object v2, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->redirectStrategy:Lorg/apache/http/client/RedirectStrategy;
    ...
    invoke-direct {v3, v0, v1, v2}, Lorg/apache/http/impl/execchain/RedirectExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/conn/routing/HttpRoutePlanner;Lorg/apache/http/client/RedirectStrategy;)V

    move-object v0, v3

    .line 1185
    :cond_2d
    iget-object v2, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->backoffManager:Lorg/apache/http/client/BackoffManager;
    ...
    invoke-direct {v4, v0, v3, v2}, Lorg/apache/http/impl/execchain/BackoffStrategyExec;-><init>(Lorg/apache/http/impl/execchain/ClientExecChain;Lorg/apache/http/client/ConnectionBackoffStrategy;Lorg/apache/http/client/BackoffManager;)V

    move-object v0, v4

    .line 1189
    :cond_2e
    iget-object v2, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->authSchemeRegistry:Lorg/apache/http/config/Lookup;
    ...
    invoke-virtual {v2, v4, v3}, Lorg/apache/http/config/RegistryBuilder;->register(Ljava/lang/String;Ljava/lang/Object;)Lorg/apache/http/config/RegistryBuilder;
    ...
    :cond_37
    :goto_10
    iget-wide v6, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->maxIdleTime:J
    ...
    new-instance v8, Lorg/apache/http/impl/client/IdleConnectionEvictor;
    ...
    invoke-direct {v6, v9, v8}, Lorg/apache/http/impl/client/HttpClientBuilder$1;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/impl/client/IdleConnectionEvictor;)V

    invoke-interface {v11, v6}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 1242
    invoke-virtual {v8}, Lorg/apache/http/impl/client/IdleConnectionEvictor;->start()V

    .line 1244
    :goto_11
    new-instance v6, Lorg/apache/http/impl/client/HttpClientBuilder$2;

    invoke-direct {v6, v9, v12}, Lorg/apache/http/impl/client/HttpClientBuilder$2;-><init>(Lorg/apache/http/impl/client/HttpClientBuilder;Lorg/apache/http/conn/HttpClientConnectionManager;)V
    ...
    .line 1254
    iget-object v6, v9, Lorg/apache/http/impl/client/HttpClientBuilder;->defaultRequestConfig:Lorg/apache/http/client/config/RequestConfig;

    if-nez v6, :cond_3b

    sget-object v6, Lorg/apache/http/client/config/RequestConfig;->DEFAULT:Lorg/apache/http/client/config/RequestConfig;
