...
.method public static contentEqualsIgnoreEOL(Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Z
    ...
    :goto_1
    :try_start_1
    invoke-static {p0, p2}, Lorg/apache/commons/io/IOUtils;->contentEqualsIgnoreEOL(Ljava/io/Reader;Ljava/io/Reader;)Z
...
.method public static isSymlink(Ljava/io/File;)Z
    ...
    .line 3107
    invoke-static {p0}, Lo/SearchIsolatedActivityaddHistorySearches11211;->yE_(Ljava/io/File;)Ljava/nio/file/Path;

    move-result-object p0

    invoke-static {p0}, Lio/uqudo/sdk/C$$ExternalSyntheticApiModelOutline0;->m(Ljava/nio/file/Path;)Z
...
.method public static moveDirectory(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string v1, "Failed to delete original directory \'"
    ...
    const-string v1, "Cannot move directory: "
    ...
    new-instance p1, Lorg/apache/commons/io/FileExistsException;

    invoke-virtual {p0}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object p0

    invoke-direct {p1, p0}, Lorg/apache/commons/io/FileExistsException;-><init>(Ljava/lang/String;)V
...
.method public static toFiles([Ljava/net/URL;)[Ljava/io/File;
    ...
    const-string v0, "URL could not be converted to a File: "
