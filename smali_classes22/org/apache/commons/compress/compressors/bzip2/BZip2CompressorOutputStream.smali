...
.method private endBlock()V
    ...
    .line 589
    invoke-direct {p0, v3, v0}, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->bsW(II)V
...
.method private generateMTFValues()V
    ...
    .line 1276
    iput v11, v0, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->nMTF:I
...
.method private sendMTFValues1(II)I
    ...
    .line 826
    :goto_2
    iget v10, v0, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->nMTF:I

    if-ge v14, v10, :cond_a

    add-int/lit8 v10, v14, 0x31
    ...
    .line 856
    aput-short v14, v5, v20

    const/4 v8, 0x1

    .line 857
    aput-short v26, v5, v8
    ...
    .line 871
    aget-short v26, v5, v22

    aget-object v27, v2, v22

    aget-byte v12, v27, v16
    ...
    invoke-static {v10, v12, v14, v0, v9}, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->hbMakeCodeLengths([B[ILorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream$Data;II)V
...
.method private sendMTFValues4()V
    ...
    invoke-direct {p0, v4, v6}, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->bsW(II)V
...
.method public write([BII)V
    ...
    invoke-direct {p0, p3}, Lorg/apache/commons/compress/compressors/bzip2/BZip2CompressorOutputStream;->write0(I)V
