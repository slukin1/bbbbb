.class Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->BASIC_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->POLICY_MAPPINGS:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->SUBJECT_ALTERNATIVE_NAME:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->NAME_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->KEY_USAGE:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->INHIBIT_ANY_POLICY:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->ISSUING_DISTRIBUTION_POINT:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->DELTA_CRL_INDICATOR:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->POLICY_CONSTRAINTS:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->CRL_NUMBER:Ljava/lang/String;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->crlReasons:[Ljava/lang/String;
...
.method protected static findCertificates(Lde/authada/org/bouncycastle/x509/X509AttributeCertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lde/authada/org/bouncycastle/jce/provider/AnnotatedException;
    ...
    instance-of v2, v1, Lde/authada/org/bouncycastle/x509/X509Store;

    if-eqz v2, :cond_0

    check-cast v1, Lde/authada/org/bouncycastle/x509/X509Store;

    :try_start_0
    invoke-virtual {v1, p0}, Lde/authada/org/bouncycastle/x509/X509Store;->getMatches(Lde/authada/org/bouncycastle/util/Selector;)Ljava/util/Collection;
...
.method protected static findCertificates(Lde/authada/org/bouncycastle/x509/X509CertStoreSelector;Ljava/util/List;)Ljava/util/Collection;
    .locals 6
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lde/authada/org/bouncycastle/jce/provider/AnnotatedException;
    ...
    new-instance v2, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;

    invoke-direct {v2}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/CertificateFactory;-><init>()V
    ...
    invoke-virtual {v2, v5}, Ljava/security/cert/CertificateFactorySpi;->engineGenerateCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;

    move-result-object v4
    :try_end_0
    .catch Lde/authada/org/bouncycastle/util/StoreException; {:try_start_0 .. :try_end_0} :catch_2
...
.method protected static getAlgorithmIdentifier(Ljava/security/PublicKey;)Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;->getAlgorithmId()Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
...
.method protected static getCertStatus(Ljava/util/Date;Ljava/security/cert/X509CRL;Ljava/lang/Object;Lde/authada/org/bouncycastle/x509/CertStatus;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lde/authada/org/bouncycastle/jce/provider/AnnotatedException;
    ...
    .line 65348
    :try_start_0
    invoke-static {p1}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->isIndirectCRL(Ljava/security/cert/X509CRL;)Z
    ...
    invoke-static {p2}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getSerialNumber(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    invoke-static {p1}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getIssuerPrincipal(Ljava/security/cert/X509CRL;)Ljavax/security/auth/x500/X500Principal;

    move-result-object v1

    :cond_0
    invoke-static {p2}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getEncodedIssuerPrincipal(Ljava/lang/Object;)Ljavax/security/auth/x500/X500Principal;
    ...
    :try_start_1
    sget-object p1, Lde/authada/org/bouncycastle/asn1/x509/X509Extension;->reasonCode:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;->getId()Ljava/lang/String;

    move-result-object p1

    invoke-static {v0, p1}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lde/authada/org/bouncycastle/asn1/ASN1Primitive;
    ...
    :cond_5
    invoke-virtual {p3, p1}, Lde/authada/org/bouncycastle/x509/CertStatus;->setCertStatus(I)V

    invoke-virtual {v0}, Ljava/security/cert/X509CRLEntry;->getRevocationDate()Ljava/util/Date;

    move-result-object p0

    invoke-virtual {p3, p0}, Lde/authada/org/bouncycastle/x509/CertStatus;->setRevocationDate(Ljava/util/Date;)V
...
.method protected static getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lde/authada/org/bouncycastle/asn1/ASN1Primitive;
    ...
    :cond_0
    invoke-static {p1, p0}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getObject(Ljava/lang/String;[B)Lde/authada/org/bouncycastle/asn1/ASN1Primitive;
...
.method private static getSerialNumber(Ljava/lang/Object;)Ljava/math/BigInteger;
    ...
    invoke-interface {p0}, Lde/authada/org/bouncycastle/x509/X509AttributeCertificate;->getSerialNumber()Ljava/math/BigInteger;
...
.method protected static prepareNextCertB1(I[Ljava/util/List;Ljava/lang/String;Ljava/util/Map;Ljava/security/cert/X509Certificate;)V
    ...
    invoke-virtual {v3, v0}, Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;->setExpectedPolicies(Ljava/util/Set;)V
    ...
    :try_start_0
    sget-object v2, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;

    invoke-static {p4, v2}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getExtensionValue(Ljava/security/cert/X509Extension;Ljava/lang/String;)Lde/authada/org/bouncycastle/asn1/ASN1Primitive;
    ...
    invoke-static {v2}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->getQualifierSet(Lde/authada/org/bouncycastle/asn1/ASN1Sequence;)Ljava/util/Set;
    ...
    sget-object v4, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->CERTIFICATE_POLICIES:Ljava/lang/String;
...
.method protected static prepareNextCertB2(I[Ljava/util/List;Ljava/lang/String;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {p3, p1, v4}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->removePolicyNode(Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;
...
.method protected static removePolicyNode(Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;[Ljava/util/List;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;
    ...
    invoke-static {p1, p2}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->removePolicyNodeRecurse([Ljava/util/List;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
...
.method private static removePolicyNodeRecurse([Ljava/util/List;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
    ...
    invoke-static {p0, v0}, Lde/authada/org/bouncycastle/x509/CertPathValidatorUtilities;->removePolicyNodeRecurse([Ljava/util/List;Lde/authada/org/bouncycastle/jce/provider/PKIXPolicyNode;)V
