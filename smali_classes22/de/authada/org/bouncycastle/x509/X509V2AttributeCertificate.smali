.class public Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;
.super Ljava/lang/Object;

# interfaces
.implements Lde/authada/org/bouncycastle/x509/X509AttributeCertificate;


# instance fields
.field private cert:Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
...
# direct methods
.method constructor <init>(Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;)V
    .locals 1
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->cert:Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->notAfter:Ljava/util/Date;

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;->getAcinfo()Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificateInfo;

    move-result-object p1

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificateInfo;->getAttrCertValidityPeriod()Lde/authada/org/bouncycastle/asn1/x509/AttCertValidityPeriod;

    move-result-object p1

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/asn1/x509/AttCertValidityPeriod;->getNotBeforeTime()Lde/authada/org/bouncycastle/asn1/ASN1GeneralizedTime;
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->notBefore:Ljava/util/Date;
    :try_end_0
...
.method public constructor <init>(Ljava/io/InputStream;)V
    ...
    .line 65353
    invoke-static {p1}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getObject(Ljava/io/InputStream;)Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;

    move-result-object p1

    invoke-direct {p0, p1}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;-><init>(Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;)V
...
.method public constructor <init>([B)V
    ...
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;-><init>(Ljava/io/InputStream;)V
...
.method private getExtensionOIDs(Z)Ljava/util/Set;
    ...
    .line 65351
    iget-object v0, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->cert:Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
    ...
    invoke-virtual {v0}, Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificateInfo;->getExtensions()Lde/authada/org/bouncycastle/asn1/x509/Extensions;
...
.method private static getObject(Ljava/io/InputStream;)Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
...
.method public checkValidity()V
    ...
    invoke-virtual {p0, v0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->checkValidity(Ljava/util/Date;)V
...
.method public checkValidity(Ljava/util/Date;)V
    ...
    .line 65348
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getNotAfter()Ljava/util/Date;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getNotBefore()Ljava/util/Date;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    :try_start_0
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getEncoded()[B

    move-result-object v0

    invoke-interface {p1}, Lde/authada/org/bouncycastle/x509/X509AttributeCertificate;->getEncoded()[B
...
.method public getAttributes()[Lde/authada/org/bouncycastle/x509/X509Attribute;
    .locals 5
    ...
    new-array v1, v1, [Lde/authada/org/bouncycastle/x509/X509Attribute;
    ...
    new-instance v3, Lde/authada/org/bouncycastle/x509/X509Attribute;
    ...
    invoke-direct {v3, v4}, Lde/authada/org/bouncycastle/x509/X509Attribute;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1Encodable;)V
...
.method public getAttributes(Ljava/lang/String;)[Lde/authada/org/bouncycastle/x509/X509Attribute;
    .locals 5
    ...
    invoke-virtual {v3}, Lde/authada/org/bouncycastle/x509/X509Attribute;->getOID()Ljava/lang/String;
    ...
    new-array p1, p1, [Lde/authada/org/bouncycastle/x509/X509Attribute;

    invoke-interface {v1, p1}, Ljava/util/List;->toArray([Ljava/lang/Object;)[Ljava/lang/Object;

    move-result-object p1

    check-cast p1, [Lde/authada/org/bouncycastle/x509/X509Attribute;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    .line 65344
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getExtensionOIDs(Z)Ljava/util/Set;
...
.method public getHolder()Lde/authada/org/bouncycastle/x509/AttributeCertificateHolder;
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->cert:Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
...
.method public getIssuer()Lde/authada/org/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    .line 65340
    new-instance v0, Lde/authada/org/bouncycastle/x509/AttributeCertificateIssuer;
    ...
    invoke-direct {v0, v1}, Lde/authada/org/bouncycastle/x509/AttributeCertificateIssuer;-><init>(Lde/authada/org/bouncycastle/asn1/x509/AttCertIssuer;)V
...
.method public getNotAfter()Ljava/util/Date;
    ...
    .line 65337
    iget-object v0, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->notAfter:Ljava/util/Date;
...
.method public getNotBefore()Ljava/util/Date;
    ...
    .line 65336
    iget-object v0, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->notBefore:Ljava/util/Date;
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    .line 65332
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public final verify(Ljava/security/PublicKey;Ljava/lang/String;)V
    ...
    invoke-virtual {v1}, Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificateInfo;->getSignature()Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    :try_start_0
    iget-object p1, p0, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->cert:Lde/authada/org/bouncycastle/asn1/x509/AttributeCertificate;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/x509/X509V2AttributeCertificate;->getSignature()[B
