.class public abstract Lo/getSortSymbolViewModel;
.super Lo/setTakeProfitValid;
.source "SourceFile"

# interfaces
.implements Lo/getFragmentUnderlying;
...
.method public final b(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 3
    instance-of v1, v0, Lo/getAskPriceOrIV;
    ...
    check-cast p1, Lo/getAskPriceOrIV;

    goto :goto_0

    :cond_1
    new-instance v0, Lo/setSwitchConfig;

    invoke-direct {v0, p1}, Lo/setSwitchConfig;-><init>(Landroid/os/IBinder;)V
    ...
    .line 6
    invoke-virtual {p0, p1}, Lo/getSortSymbolViewModel;->a(Lo/getAskPriceOrIV;)V
