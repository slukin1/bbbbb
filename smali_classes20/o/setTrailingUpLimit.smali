.class public abstract Lo/setTrailingUpLimit;
.super Lo/UmGridOrderUseCasecombineAssetList1;
.source "SourceFile"

# interfaces
.implements Lo/setTradeFromShare;
...
.method public final e(ILandroid/os/Parcel;Landroid/os/Parcel;I)Z
    ...
    .line 1
    :cond_0
    invoke-virtual {p0}, Lo/setTrailingUpLimit;->a()V

    goto :goto_0

    .line 2
    :cond_1
    invoke-virtual {p0}, Lo/setTrailingUpLimit;->e()V
