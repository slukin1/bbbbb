...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements4;,
        Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements2;
    }
.end annotation
...
.field b:Landroidx/appcompat/view/menu/MenuBuilder$DropdropElements1;

.field private c:Z

.field d:Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements2;

.field e:Lo/addOnPictureInPictureModeChangedListener;
...
.field private j:Lo/onRequestPermissionsResult;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-boolean v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->c:Z
...
.method private c()V
    ...
    iget-object v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Lo/addOnPictureInPictureModeChangedListener;

    .line 1722
    iget v1, v1, Lo/addOnPictureInPictureModeChangedListener;->o:I
    ...
    .line 194
    iget-boolean v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->c:Z

    if-nez v1, :cond_1

    iget-boolean v1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->a:Z
    ...
    .line 199
    iget-object v2, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Lo/addOnPictureInPictureModeChangedListener;

    invoke-virtual {v2}, Lo/addOnPictureInPictureModeChangedListener;->getContentDescription()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lo/addOnPictureInPictureModeChangedListener;->getTitle()Ljava/lang/CharSequence;
    ...
    invoke-virtual {v2}, Lo/addOnPictureInPictureModeChangedListener;->getTooltipText()Ljava/lang/CharSequence;
    ...
    .line 211
    :cond_5
    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Lo/addOnPictureInPictureModeChangedListener;
    ...
    :goto_5
    invoke-static {p0, v1}, Lo/startIntentSenderForResult;->c(Landroid/view/View;Ljava/lang/CharSequence;)V
...
.method public final a()Z
    ...
    invoke-virtual {v0}, Lo/addOnPictureInPictureModeChangedListener;->getIcon()Landroid/graphics/drawable/Drawable;
...
.method public initialize(Lo/addOnPictureInPictureModeChangedListener;I)V
    ...
    .line 128
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Lo/addOnPictureInPictureModeChangedListener;
    ...
    .line 137
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lo/onRequestPermissionsResult;

    if-nez p1, :cond_2

    .line 138
    new-instance p1, Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements4;

    invoke-direct {p1, p0}, Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements4;-><init>(Landroidx/appcompat/view/menu/ActionMenuItemView;)V

    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lo/onRequestPermissionsResult;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 154
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->b:Landroidx/appcompat/view/menu/MenuBuilder$DropdropElements1;
    ...
    invoke-interface {p1, v0}, Landroidx/appcompat/view/menu/MenuBuilder$DropdropElements1;->a(Lo/addOnPictureInPictureModeChangedListener;)Z
...
.method public onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v0}, Lo/addOnPictureInPictureModeChangedListener;->hasSubMenu()Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->j:Lo/onRequestPermissionsResult;
...
.method public setExpandedFormat(Z)V
    ...
    .line 185
    iget-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->e:Lo/addOnPictureInPictureModeChangedListener;
    ...
    invoke-virtual {v0, p1}, Landroidx/appcompat/view/menu/MenuBuilder;->onItemActionRequestChanged(Lo/addOnPictureInPictureModeChangedListener;)V
...
.method public setItemInvoker(Landroidx/appcompat/view/menu/MenuBuilder$DropdropElements1;)V
    .locals 0

    .line 160
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->b:Landroidx/appcompat/view/menu/MenuBuilder$DropdropElements1;
...
.method public setPopupCallback(Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements2;)V
    .locals 0

    .line 164
    iput-object p1, p0, Landroidx/appcompat/view/menu/ActionMenuItemView;->d:Landroidx/appcompat/view/menu/ActionMenuItemView$DropdropElements2;
