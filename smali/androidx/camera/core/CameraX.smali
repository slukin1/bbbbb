...
.field private final mInitInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field private mShutdownInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lo/W3AlphaLimitCexSelectViewmodelrefresh11<",
            "Ljava/lang/Void;",
...
.method public constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;)V
    ...
    invoke-direct {p0, p1, p2, v0}, Landroidx/camera/core/CameraX;-><init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;Lo/run;)V

    return-void
.end method

.method constructor <init>(Landroid/content/Context;Landroidx/camera/core/CameraXConfig$Provider;Lo/run;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    ...
    invoke-static {p1, p2, p3}, Landroidx/camera/core/CameraX;->updateQuirkSettings(Landroid/content/Context;Landroidx/camera/core/impl/QuirkSettings;Lo/run;)V
    ...
    invoke-virtual {p2}, Landroidx/camera/core/CameraXConfig;->getCameraProviderInitRetryPolicy()Landroidx/camera/core/RetryPolicy;

    move-result-object p2

    invoke-direct {p3, p2}, Landroidx/camera/core/RetryPolicy$Builder;-><init>(Landroidx/camera/core/RetryPolicy;)V
    ...
    .line 148
    invoke-direct {p0, p1}, Landroidx/camera/core/CameraX;->initInternal(Landroid/content/Context;)Lo/W3AlphaLimitCexSelectViewmodelrefresh11;

    move-result-object p1

    iput-object p1, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
...
.method private static increaseMinLogLevelReference(Ljava/lang/Integer;)V
    ...
    invoke-static {v1, v3, v4, v2}, Lo/AndroidTextContextMenuToolbarProvidershowTextContextMenu2;->e(IIILjava/lang/String;)I
...
.method private initAndRetryRecursively(Ljava/util/concurrent/Executor;JILandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V
    .locals 9
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct/range {v0 .. v7}, Landroidx/camera/core/CameraX$$ExternalSyntheticLambda2;-><init>(Landroidx/camera/core/CameraX;Landroid/content/Context;Ljava/util/concurrent/Executor;ILandroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;J)V
...
.method private initInternal(Landroid/content/Context;)Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private shutdownInternal()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 497
    :cond_1
    iget-object v1, p0, Landroidx/camera/core/CameraX;->mShutdownInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
...
.method private traceExecutionState(Landroidx/camera/core/RetryPolicy$ExecutionState;)V
    ...
    .line 3212
    invoke-static {v2, p1}, Lo/PublicKeyCredentialControllerUtility;->d(Ljava/lang/String;I)V

    return-void

    .line 3214
    :cond_2
    invoke-static {v2, p1}, Lo/CredentialProviderCreatePublicKeyCredentialControllerresultReceiver1onReceiveResult1;->e(Ljava/lang/String;I)V
...
.method private static updateQuirkSettings(Landroid/content/Context;Landroidx/camera/core/impl/QuirkSettings;Lo/run;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 249
    :cond_0
    invoke-interface {p2, p0}, Lo/run;->apply(Ljava/lang/Object;)Ljava/lang/Object;
...
# virtual methods
.method public final getCameraDeviceSurfaceManager()Landroidx/camera/core/impl/CameraDeviceSurfaceManager;
    .locals 2
...
.method public final getCameraFactory()Landroidx/camera/core/impl/CameraFactory;
    .locals 2
...
.method public final getDefaultConfigFactory()Landroidx/camera/core/impl/UseCaseConfigFactory;
    .locals 2
...
.method public final getInitializeFuture()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 306
    iget-object v0, p0, Landroidx/camera/core/CameraX;->mInitInternalFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
...
.method final synthetic lambda$initAndRetryRecursively$1$androidx-camera-core-CameraX(Ljava/util/concurrent/Executor;JILandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V
    .locals 7
    ...
    .line 412
    invoke-direct/range {v0 .. v6}, Landroidx/camera/core/CameraX;->initAndRetryRecursively(Ljava/util/concurrent/Executor;JILandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V

    return-void
.end method

.method final synthetic lambda$initAndRetryRecursively$2$androidx-camera-core-CameraX(Landroid/content/Context;Ljava/util/concurrent/Executor;ILandroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;J)V
    .locals 16
    ...
    .line 401
    invoke-virtual {v8, v1}, Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;->c(Ljava/lang/Object;)Z
    :try_end_1
    ...
    new-instance v11, Landroidx/camera/core/CameraX$$ExternalSyntheticLambda1;
    ...
    invoke-direct/range {v1 .. v8}, Landroidx/camera/core/CameraX$$ExternalSyntheticLambda1;-><init>(Landroidx/camera/core/CameraX;Ljava/util/concurrent/Executor;JILandroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V
    ...
    invoke-static {v0, v11, v3, v1, v2}, Lo/LongPressTextDragObserverKtdetectDownAndDragGesturesWithObserver2;->a(Landroid/os/Handler;Ljava/lang/Runnable;Ljava/lang/Object;J)Z
    ...
    invoke-virtual {v8, v0}, Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;->b(Ljava/lang/Throwable;)Z
    :try_end_6
...
.method final synthetic lambda$initInternal$0$androidx-camera-core-CameraX(Landroid/content/Context;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)Ljava/lang/Object;
    .locals 7
...
.method final synthetic lambda$shutdownInternal$3$androidx-camera-core-CameraX(Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V
    .locals 2
...
.method final synthetic lambda$shutdownInternal$4$androidx-camera-core-CameraX(Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)Ljava/lang/Object;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/Exception;
    ...
    invoke-virtual {v0}, Landroidx/camera/core/impl/CameraRepository;->deinit()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    ...
    invoke-direct {v1, p0, p1}, Landroidx/camera/core/CameraX$$ExternalSyntheticLambda0;-><init>(Landroidx/camera/core/CameraX;Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)V
...
.method public final shutdown()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 316
    invoke-direct {p0}, Landroidx/camera/core/CameraX;->shutdownInternal()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
