...
.method constructor <init>(Landroid/util/Size;I)V
    ...
    iput-object p1, p0, Landroidx/camera/core/processing/SurfaceEdge$SettableSurface;->mSurfaceFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
...
.method synthetic lambda$close$1$androidx-camera-core-processing-SurfaceEdge$SettableSurface()V
    ...
    .line 715
    iget-object v0, p0, Landroidx/camera/core/processing/SurfaceEdge$SettableSurface;->mCompleter:Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;

    invoke-virtual {v0}, Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;->c()Z

    :cond_1
    return-void
.end method

.method synthetic lambda$new$0$androidx-camera-core-processing-SurfaceEdge$SettableSurface(Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;)Ljava/lang/Object;
    .locals 1
    ...
    .line 621
    iput-object p1, p0, Landroidx/camera/core/processing/SurfaceEdge$SettableSurface;->mCompleter:Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;
...
.method public provideSurface()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 639
    iget-object v0, p0, Landroidx/camera/core/processing/SurfaceEdge$SettableSurface;->mSurfaceFuture:Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
...
.method public setProvider(Landroidx/camera/core/impl/DeferrableSurface;Ljava/lang/Runnable;)Z
    ...
    .line 696
    invoke-virtual {p1}, Landroidx/camera/core/impl/DeferrableSurface;->getSurface()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;

    move-result-object v0

    iget-object v1, p0, Landroidx/camera/core/processing/SurfaceEdge$SettableSurface;->mCompleter:Landroidx/concurrent/futures/CallbackToFutureAdapter$DropdropElements2;
    ...
    .line 698
    invoke-virtual {p0}, Landroidx/camera/core/impl/DeferrableSurface;->getTerminationFuture()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    ...
    invoke-interface {v0, v1, v3}, Lo/W3AlphaLimitCexSelectViewmodelrefresh11;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    .line 700
    invoke-virtual {p1}, Landroidx/camera/core/impl/DeferrableSurface;->getCloseFuture()Lo/W3AlphaLimitCexSelectViewmodelrefresh11;
    ...
    invoke-interface {p1, p2, v0}, Lo/W3AlphaLimitCexSelectViewmodelrefresh11;->addListener(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
    ...
    const-string p2, "The parent is closed. Call SurfaceEdge#invalidate() before setting a new provider."
    ...
    const-string p2, "A different provider has been set. To change the provider, call SurfaceEdge#invalidate before calling SurfaceEdge#setProvider"
