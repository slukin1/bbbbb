.class public final Lcn/jiguang/privates/core/cs;
.super Lcn/jiguang/privates/core/cr;
...
.method public constructor <init>(II)V
    ...
    .line 65354
    invoke-direct {p0}, Lcn/jiguang/privates/core/cr;-><init>()V

    iput p1, p0, Lcn/jiguang/privates/core/cs;->g:I
    ...
    iput-object p1, p0, Lcn/jiguang/privates/core/cs;->h:Ljava/nio/ByteBuffer;

    iput p2, p0, Lcn/jiguang/privates/core/cr;->f:I
...
.method private b([B)Z
    ...
    :cond_1
    iget-object v2, p0, Lcn/jiguang/privates/core/cr;->b:Ljava/nio/channels/SocketChannel;
    ...
    invoke-virtual {p0}, Lcn/jiguang/privates/core/cr;->close()V
...
.method public final a(Ljava/lang/String;I)I
    ...
    :try_start_0
    invoke-super {p0, p1, p2}, Lcn/jiguang/privates/core/cr;->a(Ljava/lang/String;I)I
    :try_end_0
    ...
    iput-object v1, p0, Lcn/jiguang/privates/core/cr;->b:Ljava/nio/channels/SocketChannel;

    invoke-static {}, Ljava/nio/channels/Selector;->open()Ljava/nio/channels/Selector;

    move-result-object v1

    iput-object v1, p0, Lcn/jiguang/privates/core/cr;->d:Ljava/nio/channels/Selector;

    iget-object v1, p0, Lcn/jiguang/privates/core/cr;->b:Ljava/nio/channels/SocketChannel;
    ...
    iget-object p1, p0, Lcn/jiguang/privates/core/cr;->b:Ljava/nio/channels/SocketChannel;
    ...
    iget-boolean v1, p0, Lcn/jiguang/privates/core/cr;->e:Z
    ...
    :cond_2
    :try_start_3
    iget-boolean p1, p0, Lcn/jiguang/privates/core/cr;->e:Z
    ...
    iget-object p2, p0, Lcn/jiguang/privates/core/cr;->d:Ljava/nio/channels/Selector;
    ...
    const-string v1, "tcp connect has failed:"
    ...
    invoke-static {v1, p2}, Lcn/jiguang/privates/core/jli;->ww(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a([B)I
    ...
    iget v3, p0, Lcn/jiguang/privates/core/cs;->g:I
    ...
    iget v0, p0, Lcn/jiguang/privates/core/cs;->g:I
    ...
    :cond_1
    invoke-direct {p0, p1}, Lcn/jiguang/privates/core/cs;->b([B)Z
...
.method public final a(I)Ljava/nio/ByteBuffer;
    ...
    invoke-virtual {p0}, Lcn/jiguang/privates/core/cs;->b()I

    move-result v2

    if-lez v2, :cond_0

    invoke-virtual {p0, v2}, Lcn/jiguang/privates/core/cs;->b(I)Ljava/nio/ByteBuffer;
    ...
    :try_start_1
    iget v5, p0, Lcn/jiguang/privates/core/cr;->c:I

    if-ge v5, v4, :cond_9

    if-lez p1, :cond_2

    iget-object v5, p0, Lcn/jiguang/privates/core/cr;->d:Ljava/nio/channels/Selector;
    ...
    invoke-static {v6, v5}, Lcn/jiguang/privates/core/jli;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v1, v2}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
    ...
    iget-object v3, p0, Lcn/jiguang/privates/core/cs;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v8, p0, Lcn/jiguang/privates/core/cs;->h:Ljava/nio/ByteBuffer;
    ...
    iget-object v9, p0, Lcn/jiguang/privates/core/cr;->a:Ljava/nio/ByteBuffer;
    ...
    iget-object v7, p0, Lcn/jiguang/privates/core/cr;->a:Ljava/nio/ByteBuffer;

    iget-object v9, p0, Lcn/jiguang/privates/core/cs;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v7, v9}, Ljava/nio/ByteBuffer;->put(Ljava/nio/ByteBuffer;)Ljava/nio/ByteBuffer;

    iget v7, p0, Lcn/jiguang/privates/core/cr;->c:I

    add-int/2addr v7, v8

    iput v7, p0, Lcn/jiguang/privates/core/cr;->c:I

    iget-object v7, p0, Lcn/jiguang/privates/core/cs;->h:Ljava/nio/ByteBuffer;

    invoke-virtual {v7}, Ljava/nio/ByteBuffer;->compact()Ljava/nio/ByteBuffer;

    iget v7, p0, Lcn/jiguang/privates/core/cr;->c:I

    iget v9, p0, Lcn/jiguang/privates/core/cr;->f:I
    ...
    iget v9, p0, Lcn/jiguang/privates/core/cr;->c:I
    ...
    invoke-static {v6, v3}, Lcn/jiguang/privates/core/jli;->d(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p1, v7, v2}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
    ...
    invoke-static {v6, p1}, Lcn/jiguang/privates/core/jli;->d(Ljava/lang/String;Ljava/lang/String;)V

    invoke-virtual {p0, v4}, Lcn/jiguang/privates/core/cs;->b(I)Ljava/nio/ByteBuffer;
    ...
    invoke-direct {p1, v0, v1}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {p1, v3, v2}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
    ...
    instance-of v1, p1, Lcn/jiguang/privates/core/cb;

    if-eqz v1, :cond_d

    check-cast p1, Lcn/jiguang/privates/core/cb;

    throw p1

    :cond_d
    new-instance v1, Lcn/jiguang/privates/core/cb;

    invoke-virtual {p1}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object p1

    invoke-direct {v1, v0, p1}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
    ...
    invoke-direct {v0, v1, p1}, Lcn/jiguang/privates/core/cb;-><init>(ILjava/lang/String;)V
...
.method public final close()V
    ...
    invoke-super {p0}, Lcn/jiguang/privates/core/cr;->close()V

    iget-object v0, p0, Lcn/jiguang/privates/core/cr;->d:Ljava/nio/channels/Selector;
    ...
    iput-object v0, p0, Lcn/jiguang/privates/core/cr;->b:Ljava/nio/channels/SocketChannel;
