...
# direct methods
.method public static final a(Landroid/content/Context;)Lo/resetInternal;
    .locals 6
    ...
    :try_start_0
    const-class v2, Lo/saveOldPosition;
    ...
    const-class v5, Lo/saveOldPosition;
    ...
    .line 15
    :goto_1
    check-cast p0, Lo/saveOldPosition;

    if-eqz p0, :cond_0

    invoke-interface {p0}, Lo/saveOldPosition;->h()Lo/resetInternal;
