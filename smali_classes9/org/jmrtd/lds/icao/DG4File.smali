...
.method static constructor <clinit>()V
    ...
    invoke-static {}, Lorg/jmrtd/lds/icao/DG4File;->getDecoderMap()Ljava/util/Map;
    ...
    new-instance v1, Lorg/jmrtd/lds/icao/DG4File$3;

    invoke-direct {v1}, Lorg/jmrtd/lds/icao/DG4File$3;-><init>()V

    invoke-direct {v0, v1}, Lorg/jmrtd/cbeff/ISO781611Encoder;-><init>(Lorg/jmrtd/cbeff/BiometricDataBlockEncoder;)V

    sput-object v0, Lorg/jmrtd/lds/icao/DG4File;->ISO_19794_ENCODER:Lorg/jmrtd/cbeff/ISO781611Encoder;

    .line 95
    new-instance v0, Lorg/jmrtd/cbeff/ISO781611Encoder;

    new-instance v1, Lorg/jmrtd/lds/icao/DG4File$4;

    invoke-direct {v1}, Lorg/jmrtd/lds/icao/DG4File$4;-><init>()V

    invoke-direct {v0, v1}, Lorg/jmrtd/cbeff/ISO781611Encoder;-><init>(Lorg/jmrtd/cbeff/BiometricDataBlockEncoder;)V

    sput-object v0, Lorg/jmrtd/lds/icao/DG4File;->ISO_39794_ENCODER:Lorg/jmrtd/cbeff/ISO781611Encoder;
...
.method public constructor <init>(Ljava/util/List;Z)V
    ...
    invoke-static {p1}, Lorg/jmrtd/lds/icao/DG4File;->fromIrisInfos(Ljava/util/List;)Ljava/util/List;
    ...
    .line 122
    iput-boolean p2, p0, Lorg/jmrtd/lds/CBEFFDataGroup;->shouldAddRandomDataIfEmpty:Z
...
.method static synthetic access$000()Ljava/util/logging/Logger;
    ...
    .line 56
    sget-object v0, Lorg/jmrtd/lds/icao/DG4File;->LOGGER:Ljava/util/logging/Logger;

    return-object v0
.end method

.method private static fromIrisInfos(Ljava/util/List;)Ljava/util/List;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    check-cast v1, Lorg/jmrtd/lds/iso19794/IrisInfo;
...
.method private static getDecoderMap()Ljava/util/Map;
    ...
    new-instance v2, Lorg/jmrtd/lds/icao/DG4File$1;

    invoke-direct {v2}, Lorg/jmrtd/lds/icao/DG4File$1;-><init>()V
    ...
    new-instance v2, Lorg/jmrtd/lds/icao/DG4File$2;

    invoke-direct {v2}, Lorg/jmrtd/lds/icao/DG4File$2;-><init>()V
...
.method private static toIrisInfos(Ljava/util/List;)Ljava/util/List;
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 221
    instance-of v2, v1, Lorg/jmrtd/lds/iso19794/IrisInfo;
...
.method public getEncoder()Lorg/jmrtd/cbeff/ISO781611Encoder;
    ...
    .line 144
    sget-object v0, Lorg/jmrtd/lds/icao/DG4File;->ISO_19794_ENCODER:Lorg/jmrtd/cbeff/ISO781611Encoder;

    return-object v0

    .line 146
    :cond_0
    sget-object v0, Lorg/jmrtd/lds/icao/DG4File$5;->$SwitchMap$org$jmrtd$cbeff$BiometricEncodingType:[I
    ...
    .line 150
    :cond_1
    sget-object v0, Lorg/jmrtd/lds/icao/DG4File;->ISO_39794_ENCODER:Lorg/jmrtd/cbeff/ISO781611Encoder;
...
.method public getIrisInfos()Ljava/util/List;
    ...
    invoke-static {v0}, Lorg/jmrtd/lds/icao/DG4File;->toIrisInfos(Ljava/util/List;)Ljava/util/List;
