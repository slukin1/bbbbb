.class public Lde/authada/org/bouncycastle/crypto/generators/Ed25519KeyPairGenerator;
...
.method public generateKeyPair()Lde/authada/org/bouncycastle/crypto/AsymmetricCipherKeyPair;
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/generators/Ed25519KeyPairGenerator;->random:Ljava/security/SecureRandom;

    invoke-direct {v0, v1}, Lde/authada/org/bouncycastle/crypto/params/Ed25519PrivateKeyParameters;-><init>(Ljava/security/SecureRandom;)V

    new-instance v1, Lde/authada/org/bouncycastle/crypto/AsymmetricCipherKeyPair;

    invoke-virtual {v0}, Lde/authada/org/bouncycastle/crypto/params/Ed25519PrivateKeyParameters;->generatePublicKey()Lde/authada/org/bouncycastle/crypto/params/Ed25519PublicKeyParameters;
...
.method public init(Lde/authada/org/bouncycastle/crypto/KeyGenerationParameters;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/generators/Ed25519KeyPairGenerator;->random:Ljava/security/SecureRandom;
