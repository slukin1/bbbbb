.class public Lde/authada/org/bouncycastle/crypto/macs/KMAC;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->padding:[B
...
.method public constructor <init>(I[B)V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->cshake:Lde/authada/org/bouncycastle/crypto/digests/CSHAKEDigest;

    iput p1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->bitLength:I

    shl-int/lit8 p1, p1, 0x1

    div-int/lit8 p1, p1, 0x8

    iput p1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->outputLength:I
...
.method private bytePad([BI)V
    ...
    invoke-virtual {p0, v0, v2, v1}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->update([BII)V

    invoke-static {p1}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->encode([B)[B

    move-result-object p1

    array-length v1, p1

    invoke-virtual {p0, p1, v2, v1}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->update([BII)V
    ...
    :goto_0
    sget-object p2, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->padding:[B
    ...
    invoke-virtual {p0, p2, v2, v0}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->update([BII)V
    ...
    :cond_0
    invoke-virtual {p0, p2, v2, p1}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->update([BII)V
...
.method public doFinal([BI)I
    ...
    .line 65350
    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->firstOutput:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->initialised:Z

    if-eqz v0, :cond_0

    invoke-virtual {p0}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->getMacSize()I
    ...
    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->cshake:Lde/authada/org/bouncycastle/crypto/digests/CSHAKEDigest;

    const/4 v2, 0x0

    array-length v3, v0

    invoke-virtual {v1, v0, v2, v3}, Lde/authada/org/bouncycastle/crypto/digests/KeccakDigest;->update([BII)V
    ...
    :cond_1
    :goto_0
    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->cshake:Lde/authada/org/bouncycastle/crypto/digests/CSHAKEDigest;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->reset()V
...
.method public doOutput([BII)I
    ...
    iput-boolean v3, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->firstOutput:Z
...
.method public getDigestSize()I
    ...
    .line 65345
    iget v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->outputLength:I
...
.method public init(Lde/authada/org/bouncycastle/crypto/CipherParameters;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->key:[B

    const/4 p1, 0x1

    iput-boolean p1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->initialised:Z
...
.method public reset()V
    ...
    iget-object v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->key:[B

    if-eqz v0, :cond_1

    iget v1, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->bitLength:I
    ...
    :goto_0
    invoke-direct {p0, v0, v1}, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->bytePad([BI)V

    :cond_1
    const/4 v0, 0x1

    iput-boolean v0, p0, Lde/authada/org/bouncycastle/crypto/macs/KMAC;->firstOutput:Z
