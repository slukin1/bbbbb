.class public Lde/authada/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;->AUTH_MAGIC:[B
...
.method private static allIntegers(Lde/authada/org/bouncycastle/asn1/ASN1Sequence;)Z
    .locals 3
...
.method public static encodePrivateKey(Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    .locals 5
    ...
    .line 65351
    instance-of v0, p0, Lde/authada/org/bouncycastle/crypto/params/RSAPrivateCrtKeyParameters;

    if-eqz v0, :cond_0

    invoke-static {p0}, Lde/authada/org/bouncycastle/crypto/util/PrivateKeyInfoFactory;->createPrivateKeyInfo(Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;)Lde/authada/org/bouncycastle/asn1/pkcs/PrivateKeyInfo;
    ...
    invoke-direct {v2, v0}, Lde/authada/org/bouncycastle/asn1/ASN1Integer;-><init>(Ljava/math/BigInteger;)V
    ...
    sget-object v2, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;->AUTH_MAGIC:[B

    invoke-virtual {v1, v2}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeBytes([B)V
    ...
    invoke-virtual {v1, v3}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->u32(I)V
    ...
    invoke-virtual {v1, v3}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeBlock([B)V

    new-instance v3, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;

    invoke-direct {v3}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;-><init>()V
    ...
    invoke-virtual {v3, v4}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->u32(I)V

    invoke-virtual {v3, v4}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->u32(I)V

    const-string v4, "ssh-ed25519"

    invoke-virtual {v3, v4}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeString(Ljava/lang/String;)V

    invoke-virtual {v0}, Lde/authada/org/bouncycastle/crypto/params/Ed25519PublicKeyParameters;->getEncoded()[B

    move-result-object v0

    invoke-virtual {v3, v0}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeBlock([B)V

    invoke-virtual {p0}, Lde/authada/org/bouncycastle/crypto/params/Ed25519PrivateKeyParameters;->getEncoded()[B

    move-result-object p0

    invoke-static {p0, v0}, Lde/authada/org/bouncycastle/util/Arrays;->concatenate([B[B)[B

    move-result-object p0

    invoke-virtual {v3, p0}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeBlock([B)V

    invoke-virtual {v3, v2}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeString(Ljava/lang/String;)V

    invoke-virtual {v3}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->getPaddedBytes()[B

    move-result-object p0

    invoke-virtual {v1, p0}, Lde/authada/org/bouncycastle/crypto/util/SSHBuilder;->writeBlock([B)V
...
.method public static parsePrivateKeyBlob([B)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;
    .locals 14
    ...
    invoke-static {p0}, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;->allIntegers(Lde/authada/org/bouncycastle/asn1/ASN1Sequence;)Z
    ...
    sget-object v1, Lde/authada/org/bouncycastle/util/BigIntegers;->ZERO:Ljava/math/BigInteger;
    ...
    new-instance v3, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;
    ...
    invoke-virtual {v2}, Lde/authada/org/bouncycastle/asn1/ASN1Integer;->getPositiveValue()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v6}, Lde/authada/org/bouncycastle/asn1/ASN1Sequence;->getObjectAt(I)Lde/authada/org/bouncycastle/asn1/ASN1Encodable;
    ...
    invoke-direct {v1, v2, v4, p0}, Lde/authada/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {v3, v0, v1}, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/DSAParameters;)V
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/asn1/sec/ECPrivateKey;->getParametersObject()Lde/authada/org/bouncycastle/asn1/ASN1Object;
    ...
    invoke-direct {v3, p0, v2}, Lde/authada/org/bouncycastle/crypto/params/ECPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;)V

    goto/16 :goto_2

    :cond_2
    new-instance v1, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;

    sget-object v2, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPrivateKeyUtil;->AUTH_MAGIC:[B

    invoke-direct {v1, v2, p0}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;-><init>([B[B)V

    const-string p0, "none"

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->readString()Ljava/lang/String;
    ...
    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->skipBlock()V

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->skipBlock()V

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->readU32()I

    move-result p0

    if-ne p0, v4, :cond_e

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->readBlock()[B

    move-result-object p0

    invoke-static {p0}, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPublicKeyUtil;->parsePublicKey([B)Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->readPaddedBlock()[B

    move-result-object p0

    invoke-virtual {v1}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;->hasRemaining()Z
    ...
    invoke-direct {v1, p0}, Lde/authada/org/bouncycastle/crypto/util/SSHBuffer;-><init>([B)V
    ...
    new-instance v2, Lde/authada/org/bouncycastle/crypto/params/Ed25519PrivateKeyParameters;

    invoke-direct {v2, p0, v0}, Lde/authada/org/bouncycastle/crypto/params/Ed25519PrivateKeyParameters;-><init>([BI)V
    ...
    invoke-static {v0}, Lde/authada/org/bouncycastle/crypto/util/SSHNamedCurves;->getByName(Ljava/lang/String;)Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;

    move-result-object v0

    if-eqz v0, :cond_6

    invoke-static {v0}, Lde/authada/org/bouncycastle/asn1/nist/NISTNamedCurves;->getByOID(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;
    ...
    invoke-direct {v4, v0, p0}, Lde/authada/org/bouncycastle/crypto/params/ECNamedDomainParameters;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Lde/authada/org/bouncycastle/asn1/x9/X9ECParameters;)V

    invoke-direct {v2, v3, v4}, Lde/authada/org/bouncycastle/crypto/params/ECPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/ECDomainParameters;)V
    ...
    invoke-direct {v6, v4, p0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v8, v4, p0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v13, v4, p0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v9, v4, p0}, Ljava/math/BigInteger;-><init>(I[B)V
    ...
    invoke-direct {v10, v4, p0}, Ljava/math/BigInteger;-><init>(I[B)V

    sget-object p0, Lde/authada/org/bouncycastle/util/BigIntegers;->ONE:Ljava/math/BigInteger;
    ...
    new-instance v2, Lde/authada/org/bouncycastle/crypto/params/RSAPrivateCrtKeyParameters;
    ...
    invoke-direct/range {v5 .. v13}, Lde/authada/org/bouncycastle/crypto/params/RSAPrivateCrtKeyParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
