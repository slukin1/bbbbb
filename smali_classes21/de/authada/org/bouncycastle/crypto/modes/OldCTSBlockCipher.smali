.class public Lde/authada/org/bouncycastle/crypto/modes/OldCTSBlockCipher;
...
.method public constructor <init>(Lde/authada/org/bouncycastle/crypto/BlockCipher;)V
    ...
    instance-of v0, p1, Lde/authada/org/bouncycastle/crypto/modes/OFBBlockCipher;

    if-nez v0, :cond_0

    instance-of v0, p1, Lde/authada/org/bouncycastle/crypto/modes/CFBBlockCipher;
    ...
    iput p1, p0, Lde/authada/org/bouncycastle/crypto/modes/OldCTSBlockCipher;->blockSize:I
...
.method public doFinal([BI)I
    ...
    invoke-interface {v3, v5, v4, v2, v4}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    instance-of v3, v3, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;

    if-eqz v3, :cond_2

    iget-object v3, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;

    check-cast v3, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;

    invoke-virtual {v3}, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;->getUnderlyingCipher()Lde/authada/org/bouncycastle/crypto/BlockCipher;

    move-result-object v3

    iget-object v5, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->buf:[B

    invoke-interface {v3, v5, v0, p1, p2}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    iget-object v5, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;

    instance-of v5, v5, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;

    if-eqz v5, :cond_5

    iget-object v5, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->cipher:Lde/authada/org/bouncycastle/crypto/BlockCipher;

    check-cast v5, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;

    invoke-virtual {v5}, Lde/authada/org/bouncycastle/crypto/modes/CBCBlockCipher;->getUnderlyingCipher()Lde/authada/org/bouncycastle/crypto/BlockCipher;

    move-result-object v5

    iget-object v6, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->buf:[B

    invoke-interface {v5, v6, v4, v2, v4}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
    ...
    :goto_4
    iget v6, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->bufOff:I
    ...
    invoke-interface {v5, v2, v4, p1, p2}, Lde/authada/org/bouncycastle/crypto/BlockCipher;->processBlock([BI[BI)I
...
.method public processByte(B[BI)I
    ...
    iget v0, p0, Lde/authada/org/bouncycastle/crypto/modes/OldCTSBlockCipher;->blockSize:I

    iget-object v1, p0, Lde/authada/org/bouncycastle/crypto/DefaultBufferedBlockCipher;->buf:[B

    iget v3, p0, Lde/authada/org/bouncycastle/crypto/modes/OldCTSBlockCipher;->blockSize:I

    invoke-static {p3, v0, v1, v2, v3}, Ljava/lang/System;->arraycopy(Ljava/lang/Object;ILjava/lang/Object;II)V

    iget p3, p0, Lde/authada/org/bouncycastle/crypto/modes/OldCTSBlockCipher;->blockSize:I
