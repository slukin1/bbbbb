.class Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;
.super Ljava/security/cert/X509CRLEntry;


# instance fields
.field private c:Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;

.field private certificateIssuer:Lde/authada/org/bouncycastle/asn1/x500/X500Name;
...
# direct methods
.method protected constructor <init>(Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;)V
    .locals 0

    .line 65354
    invoke-direct {p0}, Ljava/security/cert/X509CRLEntry;-><init>()V

    iput-object p1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;

    const/4 p1, 0x0

    iput-object p1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:Lde/authada/org/bouncycastle/asn1/x500/X500Name;

    return-void
.end method

.method protected constructor <init>(Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;ZLde/authada/org/bouncycastle/asn1/x500/X500Name;)V
    .locals 0
    ...
    invoke-direct {p0, p2, p3}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->loadCertificateIssuer(ZLde/authada/org/bouncycastle/asn1/x500/X500Name;)Lde/authada/org/bouncycastle/asn1/x500/X500Name;
...
.method private getExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x509/Extension;
    .locals 1

    .line 65352
    iget-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;
...
.method private loadCertificateIssuer(ZLde/authada/org/bouncycastle/asn1/x500/X500Name;)Lde/authada/org/bouncycastle/asn1/x500/X500Name;
    .locals 3
    ...
    .line 65350
    :cond_0
    sget-object p1, Lde/authada/org/bouncycastle/asn1/x509/Extension;->certificateIssuer:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;

    invoke-direct {p0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x509/Extension;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    .line 65349
    :cond_0
    instance-of v0, p1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;

    if-eqz v0, :cond_2

    check-cast p1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;

    iget-boolean v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValueSet:Z

    if-eqz v0, :cond_1

    iget-boolean v0, p1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValueSet:Z

    if-eqz v0, :cond_1

    iget v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValue:I

    iget v1, p1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValue:I
    ...
    iget-object p1, p1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;
...
.method public getCertificateIssuer()Ljavax/security/auth/x500/X500Principal;
    ...
    .line 65348
    iget-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:Lde/authada/org/bouncycastle/asn1/x500/X500Name;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->certificateIssuer:Lde/authada/org/bouncycastle/asn1/x500/X500Name;
...
.method public getCriticalExtensionOIDs()Ljava/util/Set;
    ...
    .line 65347
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getExtensionOIDs(Z)Ljava/util/Set;
...
.method public getExtensionValue(Ljava/lang/String;)[B
    ...
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Lde/authada/org/bouncycastle/asn1/x509/Extension;
...
.method public hasUnsupportedCriticalExtension()Z
    ...
    .line 65340
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->getCriticalExtensionOIDs()Ljava/util/Set;
...
.method public hashCode()I
    ...
    iput v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValue:I

    const/4 v0, 0x1

    iput-boolean v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->hashValueSet:Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/x509/X509CRLEntryObject;->c:Lde/authada/org/bouncycastle/asn1/x509/TBSCertList$CRLEntry;
    ...
    invoke-static {v5}, Lde/authada/org/bouncycastle/asn1/x509/CRLReason;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/asn1/x509/CRLReason;
    ...
    :cond_0
    sget-object v5, Lde/authada/org/bouncycastle/asn1/x509/Extension;->certificateIssuer:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-static {v6}, Lde/authada/org/bouncycastle/asn1/x509/GeneralNames;->getInstance(Ljava/lang/Object;)Lde/authada/org/bouncycastle/asn1/x509/GeneralNames;
