.class public Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/RSAUtil;
.super Ljava/lang/Object;


# static fields
.field public static final rsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/RSAUtil;->rsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
...
.method static generateExponentFingerprint(Ljava/math/BigInteger;)Ljava/lang/String;
    ...
    invoke-direct {v0, p0, v1}, Lde/authada/org/bouncycastle/util/Fingerprint;-><init>([BI)V
...
.method static generatePrivateKeyParameter(Ljava/security/interfaces/RSAPrivateKey;)Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;
    .locals 10

    .line 65350
    instance-of v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;

    if-eqz v0, :cond_0

    check-cast p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;

    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPrivateKey;->engineGetKeyParameters()Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;
    ...
    :cond_1
    new-instance v0, Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;
    ...
    invoke-direct {v0, v2, v1, p0}, Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;-><init>(ZLjava/math/BigInteger;Ljava/math/BigInteger;)V

    return-object v0
.end method

.method static generatePublicKeyParameter(Ljava/security/interfaces/RSAPublicKey;)Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;
    .locals 3

    .line 65349
    instance-of v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;

    if-eqz v0, :cond_0

    check-cast p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;

    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/BCRSAPublicKey;->engineGetKeyParameters()Lde/authada/org/bouncycastle/crypto/params/RSAKeyParameters;
...
.method public static isRsaOid(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Z
    .locals 4
    ...
    .line 65348
    :goto_0
    sget-object v2, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/rsa/RSAUtil;->rsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
