.class public Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi;
...
.method public engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
    ...
    new-instance v0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;

    check-cast p1, Ljava/security/spec/DSAPrivateKeySpec;

    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;-><init>(Ljava/security/spec/DSAPrivateKeySpec;)V
    ...
    instance-of v0, p1, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;
    ...
    invoke-virtual {p1}, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;->getX()Ljava/math/BigInteger;
    ...
    invoke-virtual {v2}, Lde/authada/org/bouncycastle/crypto/params/DSAParameters;->getP()Ljava/math/BigInteger;
    ...
    invoke-virtual {v3}, Lde/authada/org/bouncycastle/crypto/params/DSAParameters;->getQ()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0, v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/util/BaseKeyFactorySpi;->engineGeneratePrivate(Ljava/security/spec/KeySpec;)Ljava/security/PrivateKey;
...
.method public engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
    ...
    :try_start_0
    new-instance v0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;

    check-cast p1, Ljava/security/spec/DSAPublicKeySpec;

    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Ljava/security/spec/DSAPublicKeySpec;)V
    :try_end_0
    ...
    new-instance v1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi$1;

    invoke-virtual {v0}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v0

    invoke-direct {v1, p0, v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi$1;-><init>(Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/KeyFactorySpi;Ljava/lang/String;Ljava/lang/Exception;)V
    ...
    instance-of v0, p1, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;

    if-eqz v0, :cond_1

    check-cast p1, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
    ...
    invoke-virtual {p0, v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/util/BaseKeyFactorySpi;->engineGeneratePublic(Ljava/security/spec/KeySpec;)Ljava/security/PublicKey;
...
.method public engineGetKeySpec(Ljava/security/Key;Ljava/lang/Class;)Ljava/security/spec/KeySpec;
    ...
    :try_start_0
    new-instance p2, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
    ...
    invoke-direct {v2, v3, v4, p1}, Lde/authada/org/bouncycastle/crypto/params/DSAParameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V

    invoke-direct {p2, v0, v2}, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/DSAParameters;)V

    new-instance p1, Lde/authada/org/bouncycastle/jcajce/spec/OpenSSHPublicKeySpec;

    invoke-static {p2}, Lde/authada/org/bouncycastle/crypto/util/OpenSSHPublicKeyUtil;->encodePublicKey(Lde/authada/org/bouncycastle/crypto/params/AsymmetricKeyParameter;)[B
    ...
    :try_start_1
    new-instance p2, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;
    ...
    invoke-direct {p2, v0, v2}, Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/DSAParameters;)V
...
.method protected engineTranslateKey(Ljava/security/Key;)Ljava/security/Key;
    ...
    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Ljava/security/interfaces/DSAPublicKey;)V
    ...
    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;-><init>(Ljava/security/interfaces/DSAPrivateKey;)V
...
.method public generatePrivate(Lde/authada/org/bouncycastle/asn1/pkcs/PrivateKeyInfo;)Ljava/security/PrivateKey;
    ...
    invoke-static {v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->isDsaOid(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)Z
    ...
    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPrivateKey;-><init>(Lde/authada/org/bouncycastle/asn1/pkcs/PrivateKeyInfo;)V
...
.method public generatePublic(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)Ljava/security/PublicKey;
    ...
    invoke-direct {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;-><init>(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)V
