.class public Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;
...
.field private transient lwKeyParams:Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->ZERO:Ljava/math/BigInteger;
...
.method public constructor <init>(Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;)V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->y:Ljava/math/BigInteger;
    ...
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->isNotNull(Lde/authada/org/bouncycastle/asn1/ASN1Encodable;)Z
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    :goto_0
    new-instance p1, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;

    iget-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->y:Ljava/math/BigInteger;

    iget-object v1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-static {v1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->toDSAParameters(Ljava/security/interfaces/DSAParams;)Lde/authada/org/bouncycastle/crypto/params/DSAParameters;

    move-result-object v1

    invoke-direct {p1, v0, v1}, Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;-><init>(Ljava/math/BigInteger;Lde/authada/org/bouncycastle/crypto/params/DSAParameters;)V

    iput-object p1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->lwKeyParams:Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
...
.method constructor <init>(Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;)V
    ...
    invoke-virtual {v3}, Lde/authada/org/bouncycastle/crypto/params/DSAParameters;->getG()Ljava/math/BigInteger;
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    sget-object v1, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->ZERO:Ljava/math/BigInteger;
    ...
    iput-object v1, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    iget-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    if-nez v0, :cond_0

    sget-object v0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->ZERO:Ljava/math/BigInteger;
...
# virtual methods
.method engineGetKeyParameters()Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
    .locals 1

    .line 65346
    iget-object v0, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->lwKeyParams:Lde/authada/org/bouncycastle/crypto/params/DSAPublicKeyParameters;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->getY()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->getParams()Ljava/security/interfaces/DSAParams;
...
.method public getEncoded()[B
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->y:Ljava/math/BigInteger;
    ...
    iget-object v3, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v3}, Ljava/security/interfaces/DSAParams;->getP()Ljava/math/BigInteger;

    move-result-object v3

    iget-object v4, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v4}, Ljava/security/interfaces/DSAParams;->getQ()Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/BCDSAPublicKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method public toString()Ljava/lang/String;
    ...
    invoke-static {v2, v3}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/dsa/DSAUtil;->generateKeyFingerprint(Ljava/math/BigInteger;Ljava/security/interfaces/DSAParams;)Ljava/lang/String;
