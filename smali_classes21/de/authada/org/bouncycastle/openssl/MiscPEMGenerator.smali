.class public Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;
...
# static fields
.field private static final dsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;

.field private static final hexEncodingTable:[B


# instance fields
.field private final encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->dsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    sput-object v0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->hexEncodingTable:[B
...
.method public constructor <init>(Ljava/lang/Object;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->obj:Ljava/lang/Object;

    const/4 p1, 0x0

    iput-object p1, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;
...
.method public constructor <init>(Ljava/lang/Object;Lde/authada/org/bouncycastle/openssl/PEMEncryptor;)V
    ...
    iput-object p2, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;

    return-void
.end method

.method private createPemObject(Ljava/lang/Object;)Lde/authada/org/bouncycastle/util/io/pem/PemObject;
    .locals 7
    ...
    .line 65351
    instance-of v0, p1, Lde/authada/org/bouncycastle/util/io/pem/PemObject;

    if-eqz v0, :cond_0

    check-cast p1, Lde/authada/org/bouncycastle/util/io/pem/PemObject;

    return-object p1

    :cond_0
    instance-of v0, p1, Lde/authada/org/bouncycastle/util/io/pem/PemObjectGenerator;

    if-eqz v0, :cond_1

    check-cast p1, Lde/authada/org/bouncycastle/util/io/pem/PemObjectGenerator;

    invoke-interface {p1}, Lde/authada/org/bouncycastle/util/io/pem/PemObjectGenerator;->generate()Lde/authada/org/bouncycastle/util/io/pem/PemObject;
    ...
    :cond_3
    instance-of v0, p1, Lde/authada/org/bouncycastle/openssl/X509TrustedCertificateBlock;

    if-eqz v0, :cond_4

    check-cast p1, Lde/authada/org/bouncycastle/openssl/X509TrustedCertificateBlock;

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/openssl/X509TrustedCertificateBlock;->getEncoded()[B
    ...
    :cond_5
    sget-object v1, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->dsaOids:[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v3, p1, v0}, Ljava/math/BigInteger;->modPow(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    :cond_8
    instance-of v0, p1, Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;

    if-eqz v0, :cond_9

    check-cast p1, Lde/authada/org/bouncycastle/asn1/x509/SubjectPublicKeyInfo;
    ...
    invoke-virtual {p1}, Lde/authada/org/bouncycastle/cert/X509AttributeCertificateHolder;->getEncoded()[B
    ...
    invoke-virtual {p1}, Lde/authada/org/bouncycastle/pkcs/PKCS10CertificationRequest;->getEncoded()[B
    ...
    :cond_b
    instance-of v0, p1, Lde/authada/org/bouncycastle/pkcs/PKCS8EncryptedPrivateKeyInfo;

    if-eqz v0, :cond_c

    check-cast p1, Lde/authada/org/bouncycastle/pkcs/PKCS8EncryptedPrivateKeyInfo;

    invoke-virtual {p1}, Lde/authada/org/bouncycastle/pkcs/PKCS8EncryptedPrivateKeyInfo;->getEncoded()[B
    ...
    :cond_c
    instance-of v0, p1, Lde/authada/org/bouncycastle/asn1/cms/ContentInfo;

    if-eqz v0, :cond_f

    check-cast p1, Lde/authada/org/bouncycastle/asn1/cms/ContentInfo;
    ...
    :goto_0
    iget-object v1, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;

    if-eqz v1, :cond_e

    invoke-interface {v1}, Lde/authada/org/bouncycastle/openssl/PEMEncryptor;->getAlgorithm()Ljava/lang/String;
    ...
    :cond_d
    iget-object v2, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;

    invoke-interface {v2}, Lde/authada/org/bouncycastle/openssl/PEMEncryptor;->getIV()[B

    move-result-object v2

    iget-object v3, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->encryptor:Lde/authada/org/bouncycastle/openssl/PEMEncryptor;

    invoke-interface {v3, p1}, Lde/authada/org/bouncycastle/openssl/PEMEncryptor;->encrypt([B)[B
    ...
    new-instance v4, Lde/authada/org/bouncycastle/util/io/pem/PemHeader;

    const-string v5, "Proc-Type"

    const-string v6, "4,ENCRYPTED"

    invoke-direct {v4, v5, v6}, Lde/authada/org/bouncycastle/util/io/pem/PemHeader;-><init>(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-direct {p0, v2}, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->getHexEncoded([B)Ljava/lang/String;

    move-result-object v1

    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    new-instance v1, Lde/authada/org/bouncycastle/util/io/pem/PemHeader;
    ...
    invoke-direct {v1, v2, v4}, Lde/authada/org/bouncycastle/util/io/pem/PemHeader;-><init>(Ljava/lang/String;Ljava/lang/String;)V

    invoke-interface {v3, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    new-instance v1, Lde/authada/org/bouncycastle/util/io/pem/PemObject;

    invoke-direct {v1, v0, v3, p1}, Lde/authada/org/bouncycastle/util/io/pem/PemObject;-><init>(Ljava/lang/String;Ljava/util/List;[B)V
    ...
    invoke-direct {v1, v0, p1}, Lde/authada/org/bouncycastle/util/io/pem/PemObject;-><init>(Ljava/lang/String;[B)V

    return-object v1

    :cond_f
    new-instance p1, Lde/authada/org/bouncycastle/util/io/pem/PemGenerationException;

    const-string v0, "unknown object passed - can\'t encode."

    invoke-direct {p1, v0}, Lde/authada/org/bouncycastle/util/io/pem/PemGenerationException;-><init>(Ljava/lang/String;)V
...
.method private getHexEncoded([B)Ljava/lang/String;
    ...
    sget-object v4, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->hexEncodingTable:[B
...
.method public generate()Lde/authada/org/bouncycastle/util/io/pem/PemObject;
    ...
    .line 65349
    :try_start_0
    iget-object v0, p0, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->obj:Ljava/lang/Object;

    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/openssl/MiscPEMGenerator;->createPemObject(Ljava/lang/Object;)Lde/authada/org/bouncycastle/util/io/pem/PemObject;
    ...
    new-instance v2, Lde/authada/org/bouncycastle/util/io/pem/PemGenerationException;

    invoke-virtual {v1}, Ljava/lang/Object;->toString()Ljava/lang/String;

    move-result-object v1

    invoke-direct {v2, v1, v0}, Lde/authada/org/bouncycastle/util/io/pem/PemGenerationException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
