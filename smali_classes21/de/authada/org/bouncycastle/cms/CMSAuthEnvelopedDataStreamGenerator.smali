.class public Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator$CMSAuthEnvelopedDataOutputStream;
    }
.end annotation
...
.method private doOpen(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;)Ljava/io/OutputStream;
    .locals 2
    ...
    .line 65353
    invoke-interface {p3}, Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;->getKey()Lde/authada/org/bouncycastle/operator/GenericKey;
    ...
    invoke-virtual {p0, p1, p2, v0, p3}, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->open(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lde/authada/org/bouncycastle/asn1/ASN1EncodableVector;Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;)Ljava/io/OutputStream;
...
# virtual methods
.method protected open(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lde/authada/org/bouncycastle/asn1/ASN1EncodableVector;Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;)Ljava/io/OutputStream;
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    sget-object p2, Lde/authada/org/bouncycastle/asn1/cms/CMSObjectIdentifiers;->authEnvelopedData:Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedGenerator;->originatorInfo:Lde/authada/org/bouncycastle/asn1/cms/OriginatorInfo;

    invoke-static {v2}, Lde/authada/org/bouncycastle/asn1/cms/AuthenticatedData;->calculateVersion(Lde/authada/org/bouncycastle/asn1/cms/OriginatorInfo;)I

    move-result v2

    int-to-long v2, v2

    invoke-direct {p2, v2, v3}, Lde/authada/org/bouncycastle/asn1/ASN1Integer;-><init>(J)V
    ...
    iget-object p2, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedGenerator;->originatorInfo:Lde/authada/org/bouncycastle/asn1/cms/OriginatorInfo;
    ...
    iget-boolean p2, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->_berEncodeRecipientSet:Z
    ...
    invoke-interface {p4}, Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;->getAlgorithmIdentifier()Lde/authada/org/bouncycastle/asn1/x509/AlgorithmIdentifier;
    ...
    new-instance p1, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator$CMSAuthEnvelopedDataOutputStream;

    invoke-virtual {v6}, Lde/authada/org/bouncycastle/asn1/ASN1Generator;->getRawOutputStream()Ljava/io/OutputStream;

    move-result-object p2

    iget p3, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->_bufferSize:I
...
.method public open(Ljava/io/OutputStream;Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;)Ljava/io/OutputStream;
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lde/authada/org/bouncycastle/cms/CMSException;,
    ...
    invoke-direct {p0, v0, p1, p2}, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->doOpen(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Ljava/io/OutputStream;Lde/authada/org/bouncycastle/operator/OutputAEADEncryptor;)Ljava/io/OutputStream;
...
.method public setBEREncodeRecipients(Z)V
    ...
    .line 65349
    iput-boolean p1, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->_berEncodeRecipientSet:Z
...
.method public setBufferSize(I)V
    ...
    .line 65348
    iput p1, p0, Lde/authada/org/bouncycastle/cms/CMSAuthEnvelopedDataStreamGenerator;->_bufferSize:I
