.class Lde/authada/org/bouncycastle/jce/provider/CrlCache;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/authada/org/bouncycastle/jce/provider/CrlCache$LocalCRLStore;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/jce/provider/CrlCache;->cache:Ljava/util/Map;
...
.method static getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lde/authada/org/bouncycastle/jcajce/PKIXCRLStore;
    .locals 4
    ...
    .line 65352
    const-class v0, Lde/authada/org/bouncycastle/jce/provider/CrlCache;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lde/authada/org/bouncycastle/jce/provider/CrlCache;->cache:Ljava/util/Map;
    ...
    check-cast v1, Lde/authada/org/bouncycastle/jcajce/PKIXCRLStore;
    ...
    invoke-interface {v1, v2}, Lde/authada/org/bouncycastle/jcajce/PKIXCRLStore;->getMatches(Lde/authada/org/bouncycastle/util/Selector;)Ljava/util/Collection;
    ...
    invoke-static {p0, p2}, Lde/authada/org/bouncycastle/jce/provider/CrlCache;->getCrlsFromLDAP(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-static {p0, p2}, Lde/authada/org/bouncycastle/jce/provider/CrlCache;->getCrls(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;

    move-result-object p0

    :goto_2
    new-instance p1, Lde/authada/org/bouncycastle/jce/provider/CrlCache$LocalCRLStore;

    new-instance v1, Lde/authada/org/bouncycastle/util/CollectionStore;

    invoke-direct {v1, p0}, Lde/authada/org/bouncycastle/util/CollectionStore;-><init>(Ljava/util/Collection;)V

    invoke-direct {p1, v1}, Lde/authada/org/bouncycastle/jce/provider/CrlCache$LocalCRLStore;-><init>(Lde/authada/org/bouncycastle/util/Store;)V

    sget-object p0, Lde/authada/org/bouncycastle/jce/provider/CrlCache;->cache:Ljava/util/Map;
