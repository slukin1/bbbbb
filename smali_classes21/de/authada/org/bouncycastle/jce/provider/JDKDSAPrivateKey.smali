.class public Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;
...
.method protected constructor <init>()V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->attrCarrier:Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;
...
.method constructor <init>(Lde/authada/org/bouncycastle/asn1/pkcs/PrivateKeyInfo;)V
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->x:Ljava/math/BigInteger;
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method constructor <init>(Lde/authada/org/bouncycastle/crypto/params/DSAPrivateKeyParameters;)V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->x:Ljava/math/BigInteger;
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
...
.method private readObject(Ljava/io/ObjectInputStream;)V
    ...
    invoke-virtual {v0, p1}, Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;->readObject(Ljava/io/ObjectInputStream;)V
...
.method private writeObject(Ljava/io/ObjectOutputStream;)V
    ...
    .line 65348
    iget-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->x:Ljava/math/BigInteger;

    invoke-virtual {p1, v0}, Ljava/io/ObjectOutputStream;->writeObject(Ljava/lang/Object;)V

    iget-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;
    ...
    iget-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->attrCarrier:Lde/authada/org/bouncycastle/jcajce/provider/asymmetric/util/PKCS12BagAttributeCarrierImpl;
...
.method public equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->getX()Ljava/math/BigInteger;
    ...
    invoke-virtual {p0}, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->getParams()Ljava/security/interfaces/DSAParams;
...
.method public getEncoded()[B
    ...
    new-instance v3, Lde/authada/org/bouncycastle/asn1/x509/DSAParameter;

    iget-object v4, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v4}, Ljava/security/interfaces/DSAParams;->getP()Ljava/math/BigInteger;

    move-result-object v4

    iget-object v5, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v5}, Ljava/security/interfaces/DSAParams;->getQ()Ljava/math/BigInteger;

    move-result-object v5

    iget-object v6, p0, Lde/authada/org/bouncycastle/jce/provider/JDKDSAPrivateKey;->dsaSpec:Ljava/security/interfaces/DSAParams;

    invoke-interface {v6}, Ljava/security/interfaces/DSAParams;->getG()Ljava/math/BigInteger;

    move-result-object v6

    invoke-direct {v3, v4, v5, v6}, Lde/authada/org/bouncycastle/asn1/x509/DSAParameter;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;)V
