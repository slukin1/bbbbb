.class public Lde/authada/org/bouncycastle/jce/provider/X509CertParser;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->PEM_PARSER:Lde/authada/org/bouncycastle/jce/provider/PEMUtil;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sData:Lde/authada/org/bouncycastle/asn1/ASN1Set;

    const/4 v1, 0x0

    iput v1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I

    iput-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->currentStream:Ljava/io/InputStream;
...
.method private getCertificate()Ljava/security/cert/Certificate;
    ...
    .line 65352
    iget-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sData:Lde/authada/org/bouncycastle/asn1/ASN1Set;

    if-eqz v0, :cond_1

    :cond_0
    iget v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I

    iget-object v1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sData:Lde/authada/org/bouncycastle/asn1/ASN1Set;
    ...
    iget v1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I

    add-int/lit8 v2, v1, 0x1

    iput v2, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I
    ...
    new-instance v1, Lde/authada/org/bouncycastle/jce/provider/X509CertificateObject;
    ...
    invoke-direct {v1, v0}, Lde/authada/org/bouncycastle/jce/provider/X509CertificateObject;-><init>(Lde/authada/org/bouncycastle/asn1/x509/Certificate;)V
...
.method private readDERCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    iput-object p1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sData:Lde/authada/org/bouncycastle/asn1/ASN1Set;

    invoke-direct {p0}, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->getCertificate()Ljava/security/cert/Certificate;
...
.method private readPEMCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    .line 65350
    sget-object v0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->PEM_PARSER:Lde/authada/org/bouncycastle/jce/provider/PEMUtil;
...
.method public engineInit(Ljava/io/InputStream;)V
    ...
    .line 65349
    iput-object p1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->currentStream:Ljava/io/InputStream;
    ...
    iput v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I
    ...
    iget-object v0, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->currentStream:Ljava/io/InputStream;
...
.method public engineRead()Ljava/lang/Object;
    ...
    iget v2, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sDataObjectCount:I
    ...
    :cond_0
    iput-object v1, p0, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->sData:Lde/authada/org/bouncycastle/asn1/ASN1Set;
    ...
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->readPEMCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
    ...
    invoke-direct {p0, v0}, Lde/authada/org/bouncycastle/jce/provider/X509CertParser;->readDERCertificate(Ljava/io/InputStream;)Ljava/security/cert/Certificate;
