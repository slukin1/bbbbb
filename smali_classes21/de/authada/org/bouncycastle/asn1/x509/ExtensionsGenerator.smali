.class public Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->dupsAllowed:Ljava/util/Set;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extensions:Ljava/util/Hashtable;

    new-instance v0, Ljava/util/Vector;

    invoke-direct {v0}, Ljava/util/Vector;-><init>()V

    iput-object v0, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extOrdering:Ljava/util/Vector;
...
.method public addExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;ZLde/authada/org/bouncycastle/asn1/ASN1Encodable;)V
    ...
    invoke-virtual {p0, p1, p2, p3}, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->addExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V
...
.method public addExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V
    ...
    .line 65351
    iget-object v0, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extensions:Ljava/util/Hashtable;
    ...
    sget-object v0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->dupsAllowed:Ljava/util/Set;
    ...
    check-cast v0, Lde/authada/org/bouncycastle/asn1/x509/Extension;

    invoke-virtual {v0}, Lde/authada/org/bouncycastle/asn1/x509/Extension;->getExtnValue()Lde/authada/org/bouncycastle/asn1/ASN1OctetString;
    ...
    :cond_0
    invoke-virtual {p3}, Lde/authada/org/bouncycastle/asn1/ASN1Sequence;->getObjects()Ljava/util/Enumeration;
    ...
    :cond_1
    :try_start_0
    iget-object p3, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extensions:Ljava/util/Hashtable;
    ...
    invoke-direct {v0, p1, p2, v1}, Lde/authada/org/bouncycastle/asn1/x509/Extension;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V

    invoke-virtual {p3, p1, v0}, Ljava/util/Dictionary;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    :try_end_0
    ...
    new-instance p2, Lde/authada/org/bouncycastle/asn1/ASN1ParsingException;

    invoke-virtual {p1}, Ljava/lang/Throwable;->getMessage()Ljava/lang/String;

    move-result-object p3

    invoke-direct {p2, p3, p1}, Lde/authada/org/bouncycastle/asn1/ASN1ParsingException;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    :cond_3
    iget-object v0, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extOrdering:Ljava/util/Vector;
    ...
    invoke-direct {v2, p3}, Lde/authada/org/bouncycastle/asn1/DEROctetString;-><init>([B)V

    invoke-direct {v1, p1, p2, v2}, Lde/authada/org/bouncycastle/asn1/x509/Extension;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;ZLde/authada/org/bouncycastle/asn1/ASN1OctetString;)V
...
.method public addExtension(Lde/authada/org/bouncycastle/asn1/x509/Extension;)V
    .locals 2
...
.method public addExtension(Lde/authada/org/bouncycastle/asn1/x509/Extensions;)V
    .locals 5

    .line 65349
    invoke-virtual {p1}, Lde/authada/org/bouncycastle/asn1/x509/Extensions;->getExtensionOIDs()[Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;
    ...
    invoke-virtual {v3}, Lde/authada/org/bouncycastle/asn1/x509/Extension;->getExtnValue()Lde/authada/org/bouncycastle/asn1/ASN1OctetString;
    ...
    invoke-virtual {p0, v2, v4, v3}, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->addExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V
...
.method public generate()Lde/authada/org/bouncycastle/asn1/x509/Extensions;
    .locals 4
    ...
    :goto_0
    iget-object v2, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extOrdering:Ljava/util/Vector;
    ...
    iget-object v2, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extensions:Ljava/util/Hashtable;

    iget-object v3, p0, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->extOrdering:Ljava/util/Vector;
    ...
    :cond_0
    new-instance v1, Lde/authada/org/bouncycastle/asn1/x509/Extensions;

    invoke-direct {v1, v0}, Lde/authada/org/bouncycastle/asn1/x509/Extensions;-><init>([Lde/authada/org/bouncycastle/asn1/x509/Extension;)V
...
.method public removeExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;)V
    .locals 2
...
.method public replaceExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;ZLde/authada/org/bouncycastle/asn1/ASN1Encodable;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->replaceExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V

    return-void
.end method

.method public replaceExtension(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V
    .locals 1

    .line 65342
    new-instance v0, Lde/authada/org/bouncycastle/asn1/x509/Extension;

    invoke-direct {v0, p1, p2, p3}, Lde/authada/org/bouncycastle/asn1/x509/Extension;-><init>(Lde/authada/org/bouncycastle/asn1/ASN1ObjectIdentifier;Z[B)V

    invoke-virtual {p0, v0}, Lde/authada/org/bouncycastle/asn1/x509/ExtensionsGenerator;->replaceExtension(Lde/authada/org/bouncycastle/asn1/x509/Extension;)V

    return-void
.end method

.method public replaceExtension(Lde/authada/org/bouncycastle/asn1/x509/Extension;)V
    .locals 2
