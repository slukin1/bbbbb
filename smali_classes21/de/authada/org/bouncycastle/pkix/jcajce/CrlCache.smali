.class Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache$LocalCRLStore;
    }
.end annotation
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;->cache:Ljava/util/Map;
...
.method static getCrl(Ljava/security/cert/CertificateFactory;Ljava/util/Date;Ljava/net/URI;)Lde/authada/org/bouncycastle/jcajce/PKIXCRLStore;
    ...
    .line 65352
    const-class v0, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;

    monitor-enter v0

    :try_start_0
    sget-object v1, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;->cache:Ljava/util/Map;
    ...
    invoke-static {p0, p2}, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;->getCrlsFromLDAP(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;
    ...
    :cond_4
    invoke-static {p0, p2}, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;->getCrls(Ljava/security/cert/CertificateFactory;Ljava/net/URI;)Ljava/util/Collection;

    move-result-object p0

    :goto_2
    new-instance p1, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache$LocalCRLStore;
    ...
    invoke-direct {p1, v1}, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache$LocalCRLStore;-><init>(Lde/authada/org/bouncycastle/util/Store;)V

    sget-object p0, Lde/authada/org/bouncycastle/pkix/jcajce/CrlCache;->cache:Ljava/util/Map;
