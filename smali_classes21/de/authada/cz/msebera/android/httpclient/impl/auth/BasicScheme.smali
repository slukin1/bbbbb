.class public Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;
...
.method public constructor <init>()V
    ...
    invoke-direct {p0, v0}, Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;-><init>(Ljava/nio/charset/Charset;)V
...
.method public constructor <init>(Ljava/nio/charset/Charset;)V
    ...
    .line 64
    iput-boolean p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;->complete:Z

    return-void
.end method

.method public static authenticate(Lde/authada/cz/msebera/android/httpclient/auth/Credentials;Ljava/lang/String;Z)Lde/authada/cz/msebera/android/httpclient/Header;
    .locals 2
    .annotation runtime Ljava/lang/Deprecated;
    .end annotation
    ...
    .line 204
    invoke-interface {p0}, Lde/authada/cz/msebera/android/httpclient/auth/Credentials;->getPassword()Ljava/lang/String;
    ...
    invoke-static {p0, p1}, Lde/authada/cz/msebera/android/httpclient/util/EncodingUtils;->getBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    .line 206
    invoke-static {p0, p1}, Lde/authada/cz/msebera/android/httpclient/extras/Base64;->encode([BI)[B
    ...
    invoke-virtual {p1, p0, p2, v0}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append([BII)V

    .line 218
    new-instance p0, Lde/authada/cz/msebera/android/httpclient/message/BufferedHeader;

    invoke-direct {p0, p1}, Lde/authada/cz/msebera/android/httpclient/message/BufferedHeader;-><init>(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;)V
...
.method public authenticate(Lde/authada/cz/msebera/android/httpclient/auth/Credentials;Lde/authada/cz/msebera/android/httpclient/HttpRequest;Lde/authada/cz/msebera/android/httpclient/protocol/HttpContext;)Lde/authada/cz/msebera/android/httpclient/Header;
    ...
    .line 162
    invoke-interface {p1}, Lde/authada/cz/msebera/android/httpclient/auth/Credentials;->getUserPrincipal()Ljava/security/Principal;
    ...
    .line 164
    invoke-interface {p1}, Lde/authada/cz/msebera/android/httpclient/auth/Credentials;->getPassword()Ljava/lang/String;
    ...
    invoke-virtual {p0, p2}, Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;->getCredentialsCharset(Lde/authada/cz/msebera/android/httpclient/HttpRequest;)Ljava/lang/String;

    move-result-object p2

    invoke-static {p1, p2}, Lde/authada/cz/msebera/android/httpclient/util/EncodingUtils;->getBytes(Ljava/lang/String;Ljava/lang/String;)[B
    ...
    .line 167
    invoke-static {p1, p2}, Lde/authada/cz/msebera/android/httpclient/extras/Base64;->encode([BI)[B
    ...
    invoke-direct {p2, p3}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;-><init>(I)V
    ...
    invoke-virtual {p2, p3}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append(Ljava/lang/String;)V
    ...
    invoke-virtual {p2, p1, p3, v0}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append([BII)V
...
.method public isComplete()Z
    ...
    .line 117
    iget-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;->complete:Z
...
.method public toString()Ljava/lang/String;
    ...
    .line 224
    iget-boolean v1, p0, Lde/authada/cz/msebera/android/httpclient/impl/auth/BasicScheme;->complete:Z
