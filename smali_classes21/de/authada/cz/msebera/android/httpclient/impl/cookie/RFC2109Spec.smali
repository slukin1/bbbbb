.class public Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->DATE_PATTERNS:[Ljava/lang/String;
...
.method public constructor <init>()V
    ...
    .line 99
    invoke-direct {p0, v0, v1}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;-><init>([Ljava/lang/String;Z)V

    return-void
.end method

.method protected varargs constructor <init>(Z[Lde/authada/cz/msebera/android/httpclient/cookie/CommonCookieAttributeHandler;)V
    .locals 0

    .line 104
    invoke-direct {p0, p2}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/CookieSpecBase;-><init>([Lde/authada/cz/msebera/android/httpclient/cookie/CommonCookieAttributeHandler;)V

    .line 105
    iput-boolean p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->oneHeader:Z
...
.method public constructor <init>([Ljava/lang/String;Z)V
    ...
    new-instance v1, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec$1;

    invoke-direct {v1}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec$1;-><init>()V
    ...
    :cond_0
    sget-object p1, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->DATE_PATTERNS:[Ljava/lang/String;
    ...
    .line 94
    iput-boolean p2, p0, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->oneHeader:Z
...
.method private doFormatManyHeaders(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;

    .line 175
    invoke-interface {v1}, Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;->getVersion()I
    ...
    invoke-direct {v3, v4}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;-><init>(I)V

    .line 177
    const-string v4, "Cookie: "

    invoke-virtual {v3, v4}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append(Ljava/lang/String;)V
    ...
    .line 181
    invoke-virtual {p0, v3, v1, v2}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->formatCookieAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;I)V

    .line 182
    new-instance v1, Lde/authada/cz/msebera/android/httpclient/message/BufferedHeader;

    invoke-direct {v1, v3}, Lde/authada/cz/msebera/android/httpclient/message/BufferedHeader;-><init>(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;)V
...
.method private doFormatOneHeader(Ljava/util/List;)Ljava/util/List;
    ...
    .line 153
    invoke-interface {v2}, Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;->getVersion()I
    ...
    .line 165
    invoke-virtual {p0, v0, v2, v1}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->formatCookieAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;I)V
...
.method protected formatCookieAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;I)V
    ...
    invoke-interface {p2}, Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;->getValue()Ljava/lang/String;

    move-result-object v1

    invoke-virtual {p0, p1, v0, v1, p3}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->formatParamAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    .line 222
    instance-of v0, p2, Lde/authada/cz/msebera/android/httpclient/cookie/ClientCookie;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Lde/authada/cz/msebera/android/httpclient/cookie/ClientCookie;

    .line 223
    const-string v2, "path"

    invoke-interface {v0, v2}, Lde/authada/cz/msebera/android/httpclient/cookie/ClientCookie;->containsAttribute(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v0, v2, p3}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->formatParamAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V
    ...
    invoke-virtual {p0, p1, v0, p2, p3}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->formatParamAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V
...
.method public formatCookies(Ljava/util/List;)Ljava/util/List;
    ...
    .line 142
    sget-object p1, Lde/authada/cz/msebera/android/httpclient/cookie/CookiePathComparator;->INSTANCE:Lde/authada/cz/msebera/android/httpclient/cookie/CookiePathComparator;
    ...
    .line 146
    :cond_0
    iget-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->oneHeader:Z

    if-eqz v0, :cond_1

    invoke-direct {p0, p1}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->doFormatOneHeader(Ljava/util/List;)Ljava/util/List;
    ...
    :cond_1
    invoke-direct {p0, p1}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->doFormatManyHeaders(Ljava/util/List;)Ljava/util/List;
...
.method protected formatParamAsVer(Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;Ljava/lang/String;Ljava/lang/String;I)V
    .locals 0
    ...
    .line 202
    invoke-virtual {p1, p2}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append(C)V

    .line 203
    invoke-virtual {p1, p3}, Lde/authada/cz/msebera/android/httpclient/util/CharArrayBuffer;->append(Ljava/lang/String;)V
...
.method public parse(Lde/authada/cz/msebera/android/httpclient/Header;Lde/authada/cz/msebera/android/httpclient/cookie/CookieOrigin;)Ljava/util/List;
    ...
    .line 118
    invoke-virtual {p0, p1, p2}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/RFC2109Spec;->parse([Lde/authada/cz/msebera/android/httpclient/HeaderElement;Lde/authada/cz/msebera/android/httpclient/cookie/CookieOrigin;)Ljava/util/List;
...
.method public validate(Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;Lde/authada/cz/msebera/android/httpclient/cookie/CookieOrigin;)V
    ...
    .line 132
    invoke-super {p0, p1, p2}, Lde/authada/cz/msebera/android/httpclient/impl/cookie/CookieSpecBase;->validate(Lde/authada/cz/msebera/android/httpclient/cookie/Cookie;Lde/authada/cz/msebera/android/httpclient/cookie/CookieOrigin;)V
