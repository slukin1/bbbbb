.class public abstract Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;
...
# instance fields
.field private final connManager:Lde/authada/cz/msebera/android/httpclient/conn/ClientConnectionManager;
...
.field private volatile wrappedConnection:Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;


# direct methods
.method protected constructor <init>(Lde/authada/cz/msebera/android/httpclient/conn/ClientConnectionManager;Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;)V
    .locals 0
    ...
    .line 102
    iput-object p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->connManager:Lde/authada/cz/msebera/android/httpclient/conn/ClientConnectionManager;

    .line 103
    iput-object p2, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->wrappedConnection:Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;

    const/4 p1, 0x0

    .line 104
    iput-boolean p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->markedReusable:Z

    .line 105
    iput-boolean p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->released:Z

    const-wide p1, 0x7fffffffffffffffL

    .line 106
    iput-wide p1, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->duration:J
...
.method public abortConnection()V
    ...
    .line 352
    :try_start_0
    iget-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->released:Z
    :try_end_0
    ...
    .line 355
    :try_start_1
    iput-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->released:Z

    .line 356
    invoke-virtual {p0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->unmarkReusable()V
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0

    .line 358
    :try_start_2
    invoke-virtual {p0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->shutdown()V
    :try_end_2
    ...
    :catch_0
    :try_start_3
    iget-object v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->connManager:Lde/authada/cz/msebera/android/httpclient/conn/ClientConnectionManager;

    iget-wide v1, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->duration:J
...
.method protected final assertNotAborted()V
    ...
    .line 131
    invoke-virtual {p0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->isReleased()Z
...
.method protected final assertValid(Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;)V
    .locals 1
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lde/authada/cz/msebera/android/httpclient/impl/conn/ConnectionShutdownException;
        }
    .end annotation
...
.method protected detach()V
    ...
    .line 114
    :try_start_0
    iput-object v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->wrappedConnection:Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;

    const-wide v0, 0x7fffffffffffffffL

    .line 115
    iput-wide v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->duration:J
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public flush()V
    ...
    .line 203
    invoke-virtual {p0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->getWrappedConnection()Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;

    move-result-object v0

    .line 204
    invoke-virtual {p0, v0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->assertValid(Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;)V
...
.method public getSSLSession()Ljavax/net/ssl/SSLSession;
    ...
    .line 305
    invoke-virtual {p0}, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->isOpen()Z
...
.method protected getWrappedConnection()Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;
    .locals 1

    .line 119
    iget-object v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->wrappedConnection:Lde/authada/cz/msebera/android/httpclient/conn/OperatedClientConnection;
...
.method public isMarkedReusable()Z
    ...
    .line 329
    iget-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->markedReusable:Z
...
.method public markReusable()V
    ...
    .line 319
    iput-boolean v0, p0, Lde/authada/cz/msebera/android/httpclient/impl/conn/AbstractClientConnAdapter;->markedReusable:Z
