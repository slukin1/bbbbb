.class public final Lde/authada/mobile/io/ktor/util/NIOKt;
...
.method public static final copy(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
    ...
    invoke-static {p0, p1, v2, v0, v1}, Lde/authada/mobile/io/ktor/util/NIOKt;->moveTo$default(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IILjava/lang/Object;)I
...
.method public static final copy(Ljava/nio/ByteBuffer;Lde/authada/mobile/io/ktor/utils/io/pool/ObjectPool;I)Ljava/nio/ByteBuffer;
    .locals 2
    ...
    invoke-static {p0, p1, v1, p2, v0}, Lde/authada/mobile/io/ktor/util/NIOKt;->moveTo$default(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IILjava/lang/Object;)I
...
.method public static synthetic copy$default(Ljava/nio/ByteBuffer;IILjava/lang/Object;)Ljava/nio/ByteBuffer;
    ...
    :cond_0
    invoke-static {p0, p1}, Lde/authada/mobile/io/ktor/util/NIOKt;->copy(Ljava/nio/ByteBuffer;I)Ljava/nio/ByteBuffer;
...
.method public static synthetic copy$default(Ljava/nio/ByteBuffer;Lde/authada/mobile/io/ktor/utils/io/pool/ObjectPool;IILjava/lang/Object;)Ljava/nio/ByteBuffer;
    .locals 0
    ...
    :cond_0
    invoke-static {p0, p1, p2}, Lde/authada/mobile/io/ktor/util/NIOKt;->copy(Ljava/nio/ByteBuffer;Lde/authada/mobile/io/ktor/utils/io/pool/ObjectPool;I)Ljava/nio/ByteBuffer;
...
.method public static synthetic decodeString$default(Ljava/nio/ByteBuffer;Ljava/nio/charset/Charset;ILjava/lang/Object;)Ljava/lang/String;
    ...
    :cond_0
    invoke-static {p0, p1}, Lde/authada/mobile/io/ktor/util/NIOKt;->decodeString(Ljava/nio/ByteBuffer;Ljava/nio/charset/Charset;)Ljava/lang/String;
...
.method public static synthetic moveTo$default(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;IILjava/lang/Object;)I
    ...
    .line 18
    :cond_0
    invoke-static {p0, p1, p2}, Lde/authada/mobile/io/ktor/util/NIOKt;->moveTo(Ljava/nio/ByteBuffer;Ljava/nio/ByteBuffer;I)I
